namespace I18N.Common {
  ...
  public partial class MonoEncodingDefaultEncoder : I18N.Common.ReferenceSourceDefaultEncoder {
    ...
    [System.Runtime.InteropServices.ComVisibleAttribute(false)]
    public override void Convert(System.Char[] chars, int charIndex, int charCount, System.Byte[] bytes, int byteIndex, int byteCount, bool flush, out int charsUsed, out int bytesUsed, out bool completed) { charsUsed = default(int); bytesUsed = default(int); completed = default(bool); }
  }
  ...
  public partial class ReferenceSourceDefaultEncoder : System.Text.Encoder, System.Runtime.Serialization.IObjectReference {
    ...
    public unsafe override int GetByteCount(char* chars, int count, bool flush) { return default(int); }
