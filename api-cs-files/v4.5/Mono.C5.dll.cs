namespace C5 {
  ...
  public abstract partial class ArrayBase<T> : C5.SequencedBase<T> {
    ...
    [C5.TestedAttribute]
    public virtual C5.IDirectedCollectionValue<T> this[int start, int count] { [C5.TestedAttribute]get { return default(C5.IDirectedCollectionValue<T>); } }
    [C5.TestedAttribute]
    public override C5.IDirectedCollectionValue<T> Backwards() { return default(C5.IDirectedCollectionValue<T>); }
    [C5.TestedAttribute]
    public virtual bool Check() { return default(bool); }
    public override T Choose() { return default(T); }
    [C5.TestedAttribute]
    ...
    public override System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
    protected virtual void insert(int i, T item) { }
    [C5.TestedAttribute]
    public override T[] ToArray() { return default(T[]); }
    protected partial class Range : C5.DirectedCollectionValueBase<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
      internal Range() { }
      [C5.TestedAttribute]
      public override int Count { [C5.TestedAttribute]get { return default(int); } }
      public override C5.Speed CountSpeed { get { return default(C5.Speed); } }
      [C5.TestedAttribute]
      public override C5.EnumerationDirection Direction { [C5.TestedAttribute]get { return default(C5.EnumerationDirection); } }
      public override bool IsEmpty { get { return default(bool); } }
      [C5.TestedAttribute]
      public override C5.IDirectedCollectionValue<T> Backwards() { return default(C5.IDirectedCollectionValue<T>); }
      C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
      public override T Choose() { return default(T); }
      [C5.TestedAttribute]
      [System.Diagnostics.DebuggerHiddenAttribute]
      public override System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
  ...
  public partial class ArrayList<T> : C5.ArrayBase<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IList<T>, C5.IQueue<T>, C5.ISequenced<T>, C5.IShowable, C5.IStack<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IEnumerable, System.Collections.IList, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    [C5.TestedAttribute]
    public virtual bool AllowsDuplicates { [C5.TestedAttribute]get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual C5.Speed ContainsSpeed { [C5.TestedAttribute]get { return default(C5.Speed); } }
    [C5.TestedAttribute]
    public override int Count { [C5.TestedAttribute]get { return default(int); } }
    public virtual bool DuplicatesByCounting { get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual bool FIFO { [C5.TestedAttribute]get { return default(bool); } [C5.TestedAttribute]set { } }
    [C5.TestedAttribute]
    public virtual T First { [C5.TestedAttribute]get { return default(T); } }
    public virtual C5.Speed IndexingSpeed { get { return default(C5.Speed); } }
    public virtual bool IsFixedSize { get { return default(bool); } }
    public virtual bool IsValid { get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual T this[int index] { [C5.TestedAttribute]get { return default(T); } [C5.TestedAttribute]set { } }
    [C5.TestedAttribute]
    public virtual T Last { [C5.TestedAttribute]get { return default(T); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    public virtual int Offset { [C5.TestedAttribute]get { return default(int); } }
    bool System.Collections.ICollection.IsSynchronized { get { return default(bool); } }
    [System.ObsoleteAttribute]
    object System.Collections.ICollection.SyncRoot { get { return default(object); } }
    object System.Collections.IList.this[int index] { get { return default(object); } set { } }
    [C5.TestedAttribute]
    public virtual C5.IList<T> Underlying { [C5.TestedAttribute]get { return default(C5.IList<T>); } }
    [C5.TestedAttribute]
    public virtual bool Add(T item) { return default(bool); }
    [C5.TestedAttribute]
    public virtual void AddAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { }
    [C5.TestedAttribute]
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    int C5.IIndexed.FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    int C5.IIndexed.FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    [C5.TestedAttribute]
    public override bool Check() { return default(bool); }
    [C5.TestedAttribute]
    ...
    [C5.TestedAttribute]
    public virtual bool ContainsAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { return default(bool); }
    [C5.TestedAttribute]
    public virtual int ContainsCount(T item) { return default(int); }
    [C5.TestedAttribute]
    ...
    [C5.TestedAttribute]
    public virtual bool Find(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public virtual C5.IList<T> FindAll(C5.Fun<T, System.Boolean> filter) { return default(C5.IList<T>); }
    [C5.TestedAttribute]
    public virtual bool FindOrAdd(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public override System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
    [C5.TestedAttribute]
    public override int GetUnsequencedHashCode() { return default(int); }
    [C5.TestedAttribute]
    public virtual int IndexOf(T item) { return default(int); }
    ...
    [C5.TestedAttribute]
    public bool IsSorted() { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool IsSorted(System.Collections.Generic.IComparer<T> c) { return default(bool); }
    public virtual C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>> ItemMultiplicities() { return default(C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>>); }
    [C5.TestedAttribute]
    public virtual int LastIndexOf(T item) { return default(int); }
    [C5.TestedAttribute]
    public virtual C5.IList<T> LastViewOf(T item) { return default(C5.IList<T>); }
    [C5.TestedAttribute]
    public virtual C5.IList<V> Map<V>(C5.Fun<T, V> mapper) { return default(C5.IList<V>); }
    public virtual C5.IList<V> Map<V>(C5.Fun<T, V> mapper, System.Collections.Generic.IEqualityComparer<V> itemequalityComparer) { return default(C5.IList<V>); }
    ...
    [C5.TestedAttribute]
    public virtual T Remove() { return default(T); }
    [C5.TestedAttribute]
    public virtual bool Remove(T item) { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool Remove(T item, out T removeditem) { removeditem = default(T); return default(bool); }
    [C5.TestedAttribute]
    public virtual void RemoveAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { }
    [C5.TestedAttribute]
    public virtual void RemoveAllCopies(T item) { }
    [C5.TestedAttribute]
    public virtual T RemoveAt(int index) { return default(T); }
    [C5.TestedAttribute]
    public virtual T RemoveFirst() { return default(T); }
    [C5.TestedAttribute]
    public virtual void RemoveInterval(int start, int count) { }
    [C5.TestedAttribute]
    public virtual T RemoveLast() { return default(T); }
    [C5.TestedAttribute]
    ...
    [C5.TestedAttribute]
    public virtual C5.IList<T> Slide(int offset) { return default(C5.IList<T>); }
    [C5.TestedAttribute]
    public virtual C5.IList<T> Slide(int offset, int size) { return default(C5.IList<T>); }
    public virtual void Sort() { }
    [C5.TestedAttribute]
    public virtual void Sort(System.Collections.Generic.IComparer<T> comparer) { }
    public virtual C5.IList<T> Span(C5.IList<T> otherView) { return default(C5.IList<T>); }
    ...
    [C5.TestedAttribute]
    public virtual bool TrySlide(int offset) { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool TrySlide(int offset, int size) { return default(bool); }
    public virtual C5.ICollectionValue<T> UniqueItems() { return default(C5.ICollectionValue<T>); }
    [C5.TestedAttribute]
    public override bool UnsequencedEquals(C5.ICollection<T> that) { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool Update(T item) { return default(bool); }
    public virtual bool Update(T item, out T olditem) { olditem = default(T); return default(bool); }
    protected override void updatecheck() { }
    [C5.TestedAttribute]
    public virtual bool UpdateOrAdd(T item) { return default(bool); }
    public virtual bool UpdateOrAdd(T item, out T olditem) { olditem = default(T); return default(bool); }
    [C5.TestedAttribute]
    public virtual C5.IList<T> View(int start, int count) { return default(C5.IList<T>); }
    [C5.TestedAttribute]
    public virtual C5.IList<T> ViewOf(T item) { return default(C5.IList<T>); }
  }
  public partial class ByteEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Byte> {
    internal ByteEqualityComparer() { }
    public static C5.ByteEqualityComparer Default { get { return default(C5.ByteEqualityComparer); } }
    public bool Equals(byte item1, byte item2) { return default(bool); }
    public int GetHashCode(byte item) { return default(int); }
  }
  public partial class C5Random : System.Random {
    public C5Random() { }
    public C5Random(long seed) { }
    [System.CLSCompliantAttribute(false)]
    public C5Random(System.UInt32[] Q) { }
    public override int Next() { return default(int); }
    public override int Next(int max) { return default(int); }
    public override int Next(int min, int max) { return default(int); }
    public override void NextBytes(System.Byte[] buffer) { }
    public override double NextDouble() { return default(double); }
    protected override double Sample() { return default(double); }
  }
  public partial class CharEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Char> {
    internal CharEqualityComparer() { }
    public static C5.CharEqualityComparer Default { get { return default(C5.CharEqualityComparer); } }
    public bool Equals(char item1, char item2) { return default(bool); }
    public int GetHashCode(char item) { return default(int); }
  }
  public partial class CircularQueue<T> : C5.SequencedBase<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IQueue<T>, C5.IShowable, C5.IStack<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public virtual bool AllowsDuplicates { get { return default(bool); } }
    public virtual T this[int i] { get { return default(T); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    public override C5.IDirectedCollectionValue<T> Backwards() { return default(C5.IDirectedCollectionValue<T>); }
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public virtual bool Check() { return default(bool); }
  ...
  public partial class ClearedRangeEventArgs : C5.ClearedEventArgs {
    public readonly System.Nullable<System.Int32> Start;
    public ClearedRangeEventArgs(bool full, int count, System.Nullable<System.Int32> start) : base (default(bool), default(int)) { }
    public override string ToString() { return default(string); }
  }
  public abstract partial class CollectionBase<T> : C5.CollectionValueBase<T> {
    ...
    public override int Count { [C5.TestedAttribute]get { return default(int); } }
    public override C5.Speed CountSpeed { get { return default(C5.Speed); } }
    public virtual System.Collections.Generic.IEqualityComparer<T> EqualityComparer { get { return default(System.Collections.Generic.IEqualityComparer<T>); } }
    [C5.TestedAttribute]
    public override bool IsEmpty { [C5.TestedAttribute]get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual bool IsReadOnly { [C5.TestedAttribute]get { return default(bool); } }
    [C5.TestedAttribute]
    protected void checkRange(int start, int count) { }
    [C5.TestedAttribute]
    public static int ComputeHashCode(C5.ICollectionValue<T> items, System.Collections.Generic.IEqualityComparer<T> itemequalityComparer) { return default(int); }
    public abstract override System.Collections.Generic.IEnumerator<T> GetEnumerator();
    public virtual int GetUnsequencedHashCode() { return default(int); }
    protected virtual void modifycheck(int thestamp) { }
    [C5.TestedAttribute]
    public static bool StaticEquals(C5.ICollection<T> collection1, C5.ICollection<T> collection2, System.Collections.Generic.IEqualityComparer<T> itemequalityComparer) { return default(bool); }
    public virtual bool UnsequencedEquals(C5.ICollection<T> otherCollection) { return default(bool); }
  ...
  public abstract partial class CollectionValueBase<T> : C5.EnumerableBase<T>, C5.ICollectionValue<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public virtual C5.EventTypeEnum ActiveEvents { get { return default(C5.EventTypeEnum); } }
    public abstract int Count { get; }
    public abstract C5.Speed CountSpeed { get; }
    public abstract bool IsEmpty { get; }
    public virtual C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    ...
    [C5.TestedAttribute]
    public virtual bool All(C5.Fun<T, System.Boolean> predicate) { return default(bool); }
    [C5.TestedAttribute]
    ...
    [C5.TestedAttribute]
    public virtual bool Exists(C5.Fun<T, System.Boolean> predicate) { return default(bool); }
    [System.Diagnostics.DebuggerHiddenAttribute]
    public virtual System.Collections.Generic.IEnumerable<T> Filter(C5.Fun<T, System.Boolean> predicate) { return default(System.Collections.Generic.IEnumerable<T>); }
    public virtual bool Find(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
    public abstract override System.Collections.Generic.IEnumerator<T> GetEnumerator();
    protected virtual void raiseCollectionChanged() { }
    protected virtual void raiseCollectionCleared(bool full, int count) { }
    protected virtual void raiseCollectionCleared(bool full, int count, System.Nullable<System.Int32> offset) { }
    ...
    public virtual bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public virtual T[] ToArray() { return default(T[]); }
    public override string ToString() { return default(string); }
    public virtual string ToString(string format, System.IFormatProvider formatProvider) { return default(string); }
  ...
  public static partial class Comparer<T> {
    [C5.TestedAttribute]
    public static System.Collections.Generic.IComparer<T> Default { get { return default(System.Collections.Generic.IComparer<T>); } }
  }
  public partial class ComparerZeroHashCodeEqualityComparer<T> : System.Collections.Generic.IEqualityComparer<T> {
    ...
    public bool Equals(T item1, T item2) { return default(bool); }
    public int GetHashCode(T item) { return default(int); }
  }
  public partial class DecimalEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Decimal> {
    internal DecimalEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.DecimalEqualityComparer Default { get { return default(C5.DecimalEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(decimal item1, decimal item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(decimal item) { return default(int); }
  }
  public partial class DelegateComparer<T> : System.Collections.Generic.IComparer<T> {
    ...
    public int Compare(T item1, T item2) { return default(int); }
  }
  public abstract partial class DictionaryBase<K, V> : C5.CollectionValueBase<C5.KeyValuePair<K, V>>, C5.ICollectionValue<C5.KeyValuePair<K, V>>, C5.IDictionary<K, V>, C5.IShowable, System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public override C5.EventTypeEnum ActiveEvents { get { return default(C5.EventTypeEnum); } }
    public virtual C5.Speed ContainsSpeed { get { return default(C5.Speed); } }
    [C5.TestedAttribute]
    public override int Count { [C5.TestedAttribute]get { return default(int); } }
    [C5.TestedAttribute]
    public override C5.Speed CountSpeed { [C5.TestedAttribute]get { return default(C5.Speed); } }
    public virtual System.Collections.Generic.IEqualityComparer<K> EqualityComparer { get { return default(System.Collections.Generic.IEqualityComparer<K>); } }
    public virtual C5.Fun<K, V> Fun { get { return default(C5.Fun<K, V>); } }
    public override bool IsEmpty { get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual bool IsReadOnly { [C5.TestedAttribute]get { return default(bool); } }
    [C5.TestedAttribute]
    public virtual V this[K key] { [C5.TestedAttribute]get { return default(V); } [C5.TestedAttribute]set { } }
    [C5.TestedAttribute]
    public virtual C5.ICollectionValue<K> Keys { [C5.TestedAttribute]get { return default(C5.ICollectionValue<K>); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    public virtual C5.ICollectionValue<V> Values { [C5.TestedAttribute]get { return default(C5.ICollectionValue<V>); } }
    ...
    [C5.TestedAttribute]
    public virtual bool Check() { return default(bool); }
    public override C5.KeyValuePair<K, V> Choose() { return default(C5.KeyValuePair<K, V>); }
    [C5.TestedAttribute]
    public virtual void Clear() { }
    public abstract object Clone();
    [C5.TestedAttribute]
    public virtual bool Contains(K key) { return default(bool); }
    public virtual bool ContainsAll<H>(System.Collections.Generic.IEnumerable<H> keys) where H : K { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool Find(K key, out V value) { value = default(V); return default(bool); }
    public virtual bool Find(ref K key, out V value) { value = default(V); return default(bool); }
    [C5.TestedAttribute]
    public virtual bool FindOrAdd(K key, ref V value) { return default(bool); }
    [C5.TestedAttribute]
    public override System.Collections.Generic.IEnumerator<C5.KeyValuePair<K, V>> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<C5.KeyValuePair<K, V>>); }
    [C5.TestedAttribute]
    public virtual bool Remove(K key) { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool Remove(K key, out V value) { value = default(V); return default(bool); }
    public override bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    [C5.TestedAttribute]
    public virtual bool Update(K key, V value) { return default(bool); }
    public virtual bool Update(K key, V value, out V oldvalue) { oldvalue = default(V); return default(bool); }
    [C5.TestedAttribute]
    public virtual bool UpdateOrAdd(K key, V value) { return default(bool); }
    public virtual bool UpdateOrAdd(K key, V value, out V oldvalue) { oldvalue = default(V); return default(bool); }
  }
  public abstract partial class DirectedCollectionBase<T> : C5.CollectionBase<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public virtual C5.EnumerationDirection Direction { [C5.TestedAttribute]get { return default(C5.EnumerationDirection); } }
    public abstract C5.IDirectedCollectionValue<T> Backwards();
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public virtual bool FindLast(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
  }
  ...
  public partial class DoubleEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Double> {
    internal DoubleEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.DoubleEqualityComparer Default { get { return default(C5.DoubleEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(double item1, double item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(double item) { return default(int); }
  }
  ...
  public abstract partial class EnumerableBase<T> : System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable {
    ...
    [C5.TestedAttribute]
    protected static int countItems(System.Collections.Generic.IEnumerable<T> items) { return default(int); }
  ...
  public static partial class EqualityComparer<T> {
    public static System.Collections.Generic.IEqualityComparer<T> Default { get { return default(System.Collections.Generic.IEqualityComparer<T>); } }
  }
  public partial class EquatableEqualityComparer<T> : System.Collections.Generic.IEqualityComparer<T> where T : System.IEquatable<T> {
    ...
    public static C5.EquatableEqualityComparer<T> Default { get { return default(C5.EquatableEqualityComparer<T>); } }
    public bool Equals(T item1, T item2) { return default(bool); }
    public int GetHashCode(T item) { return default(int); }
  }
  ...
  public partial class FloatEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Single> {
    internal FloatEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.FloatEqualityComparer Default { get { return default(C5.FloatEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(float item1, float item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(float item) { return default(int); }
  }
  ...
  public partial class GuardedCollection<T> : C5.GuardedCollectionValue<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IExtensible<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    void System.Collections.Generic.ICollection<T>.Add(T item) { }
    public virtual C5.ICollectionValue<T> UniqueItems() { return default(C5.ICollectionValue<T>); }
    public virtual bool UnsequencedEquals(C5.ICollection<T> that) { return default(bool); }
    public virtual bool Update(T item) { return default(bool); }
    public virtual bool Update(T item, out T olditem) { olditem = default(T); return default(bool); }
    public virtual bool UpdateOrAdd(T item) { return default(bool); }
    public virtual bool UpdateOrAdd(T item, out T olditem) { olditem = default(T); return default(bool); }
  ...
  public partial class GuardedCollectionValue<T> : C5.GuardedEnumerable<T>, C5.ICollectionValue<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public virtual C5.Speed CountSpeed { get { return default(C5.Speed); } }
    ...
    public virtual bool All(C5.Fun<T, System.Boolean> filter) { return default(bool); }
    public virtual void Apply(C5.Act<T> a) { }
    public virtual T Choose() { return default(T); }
    public virtual void CopyTo(T[] a, int i) { }
    public virtual bool Exists(C5.Fun<T, System.Boolean> filter) { return default(bool); }
    public virtual System.Collections.Generic.IEnumerable<T> Filter(C5.Fun<T, System.Boolean> filter) { return default(System.Collections.Generic.IEnumerable<T>); }
    public virtual bool Find(C5.Fun<T, System.Boolean> filter, out T item) { item = default(T); return default(bool); }
    public bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public virtual T[] ToArray() { return default(T[]); }
  ...
  public partial class GuardedDictionary<K, V> : C5.GuardedCollectionValue<C5.KeyValuePair<K, V>>, C5.ICollectionValue<C5.KeyValuePair<K, V>>, C5.IDictionary<K, V>, C5.IShowable, System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public C5.Speed ContainsSpeed { get { return default(C5.Speed); } }
    public System.Collections.Generic.IEqualityComparer<K> EqualityComparer { get { return default(System.Collections.Generic.IEqualityComparer<K>); } }
    public virtual C5.Fun<K, V> Fun { get { return default(C5.Fun<K, V>); } }
    public bool IsReadOnly { get { return default(bool); } }
    public V this[K key] { get { return default(V); } set { } }
    public C5.ICollectionValue<K> Keys { get { return default(C5.ICollectionValue<K>); } }
    public C5.ICollectionValue<V> Values { get { return default(C5.ICollectionValue<V>); } }
    public void Add(K key, V val) { }
    public void AddAll<L, W>(System.Collections.Generic.IEnumerable<C5.KeyValuePair<L, W>> items) where L : K where W : V { }
    public bool Check() { return default(bool); }
    public void Clear() { }
    public virtual object Clone() { return default(object); }
    public bool Contains(K key) { return default(bool); }
    public bool ContainsAll<H>(System.Collections.Generic.IEnumerable<H> keys) where H : K { return default(bool); }
    public bool Find(K key, out V val) { val = default(V); return default(bool); }
    public bool Find(ref K key, out V val) { val = default(V); return default(bool); }
    public bool FindOrAdd(K key, ref V val) { return default(bool); }
    public bool Remove(K key) { return default(bool); }
    public bool Remove(K key, out V val) { val = default(V); return default(bool); }
    public bool Update(K key, V val) { return default(bool); }
    public bool Update(K key, V val, out V oldval) { oldval = default(V); return default(bool); }
    public bool UpdateOrAdd(K key, V val) { return default(bool); }
    public bool UpdateOrAdd(K key, V val, out V oldval) { oldval = default(V); return default(bool); }
  }
  public partial class GuardedDirectedCollectionValue<T> : C5.GuardedCollectionValue<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public C5.EnumerationDirection Direction { get { return default(C5.EnumerationDirection); } }
    public virtual C5.IDirectedCollectionValue<T> Backwards() { return default(C5.IDirectedCollectionValue<T>); }
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public virtual bool FindLast(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
  }
  public partial class GuardedDirectedEnumerable<T> : C5.GuardedEnumerable<T>, C5.IDirectedEnumerable<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable {
    ...
    public C5.EnumerationDirection Direction { get { return default(C5.EnumerationDirection); } }
    public C5.IDirectedEnumerable<T> Backwards() { return default(C5.IDirectedEnumerable<T>); }
  }
  ...
  public partial class GuardedIndexedSorted<T> : C5.GuardedSorted<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IIndexedSorted<T>, C5.ISequenced<T>, C5.IShowable, C5.ISorted<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public virtual C5.Speed IndexingSpeed { get { return default(C5.Speed); } }
    public T this[int i] { get { return default(T); } }
    public C5.IDirectedCollectionValue<T> this[int start, int end] { get { return default(C5.IDirectedCollectionValue<T>); } }
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    int C5.IIndexed.FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    int C5.IIndexed.FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public override object Clone() { return default(object); }
    public int CountFrom(T bot) { return default(int); }
    public int CountFromTo(T bot, T top) { return default(int); }
    public int CountTo(T top) { return default(int); }
    public C5.IIndexedSorted<T> FindAll(C5.Fun<T, System.Boolean> f) { return default(C5.IIndexedSorted<T>); }
    public int IndexOf(T item) { return default(int); }
    public int LastIndexOf(T item) { return default(int); }
    public C5.IIndexedSorted<V> Map<V>(C5.Fun<T, V> m, System.Collections.Generic.IComparer<V> c) { return default(C5.IIndexedSorted<V>); }
    public new C5.IDirectedCollectionValue<T> RangeFrom(T bot) { return default(C5.IDirectedCollectionValue<T>); }
    public new C5.IDirectedCollectionValue<T> RangeFromTo(T bot, T top) { return default(C5.IDirectedCollectionValue<T>); }
    public new C5.IDirectedCollectionValue<T> RangeTo(T top) { return default(C5.IDirectedCollectionValue<T>); }
    public T RemoveAt(int i) { return default(T); }
  ...
  public partial class GuardedList<T> : C5.GuardedSequenced<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IList<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IEnumerable, System.Collections.IList, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    public bool FIFO { get { return default(bool); } set { } }
    ...
    object System.Collections.ICollection.SyncRoot { get { return default(object); } }
    object System.Collections.IList.this[int index] { get { return default(object); } set { } }
    public C5.IList<T> Underlying { get { return default(C5.IList<T>); } }
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    int C5.IIndexed.FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    int C5.IIndexed.FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public override object Clone() { return default(object); }
    ...
    public C5.IList<T> FindAll(C5.Fun<T, System.Boolean> filter) { return default(C5.IList<T>); }
    public int IndexOf(T item) { return default(int); }
    public void Insert(C5.IList<T> pointer, T item) { }
    ...
    public bool IsSorted() { return default(bool); }
    public bool IsSorted(System.Collections.Generic.IComparer<T> c) { return default(bool); }
    public int LastIndexOf(T item) { return default(int); }
    public C5.IList<T> LastViewOf(T item) { return default(C5.IList<T>); }
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper) { return default(C5.IList<V>); }
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper, System.Collections.Generic.IEqualityComparer<V> itemequalityComparer) { return default(C5.IList<V>); }
    public T Pop() { return default(T); }
    public void Push(T item) { }
    public T Remove() { return default(T); }
    public T RemoveAt(int i) { return default(T); }
    ...
    public C5.IList<T> Slide(int offset) { return default(C5.IList<T>); }
    public C5.IList<T> Slide(int offset, int size) { return default(C5.IList<T>); }
    public void Sort() { }
    public void Sort(System.Collections.Generic.IComparer<T> c) { }
    public C5.IList<T> Span(C5.IList<T> otherView) { return default(C5.IList<T>); }
    void System.Collections.Generic.ICollection<T>.Add(T item) { }
    void System.Collections.Generic.IList<T>.RemoveAt(int index) { }
    void System.Collections.ICollection.CopyTo(System.Array arr, int index) { }
    int System.Collections.IList.Add(object o) { return default(int); }
    ...
    void System.Collections.IList.Remove(object o) { }
    void System.Collections.IList.RemoveAt(int index) { }
    public bool TrySlide(int offset) { return default(bool); }
    public bool TrySlide(int offset, int size) { return default(bool); }
    public C5.IList<T> View(int start, int count) { return default(C5.IList<T>); }
    public C5.IList<T> ViewOf(T item) { return default(C5.IList<T>); }
  }
  public partial class GuardedQueue<T> : C5.GuardedDirectedCollectionValue<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IQueue<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public bool AllowsDuplicates { get { return default(bool); } }
    public T this[int i] { get { return default(T); } }
    public T Dequeue() { return default(T); }
    public void Enqueue(T item) { }
  }
  public partial class GuardedSequenced<T> : C5.GuardedCollection<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public override object Clone() { return default(object); }
    public int FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public virtual bool FindLast(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
    public int FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public int GetSequencedHashCode() { return default(int); }
    public bool SequencedEquals(C5.ISequenced<T> that) { return default(bool); }
  }
  public partial class GuardedSorted<T> : C5.GuardedSequenced<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.ISequenced<T>, C5.IShowable, C5.ISorted<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public override object Clone() { return default(object); }
    public bool Cut(System.IComparable<T> c, out T low, out bool lval, out T high, out bool hval) { low = default(T); lval = default(bool); high = default(T); hval = default(bool); return default(bool); }
    public T DeleteMax() { return default(T); }
    public T DeleteMin() { return default(T); }
    public T FindMax() { return default(T); }
    public T FindMin() { return default(T); }
    public T Predecessor(T item) { return default(T); }
    public C5.IDirectedCollectionValue<T> RangeAll() { return default(C5.IDirectedCollectionValue<T>); }
    public C5.IDirectedEnumerable<T> RangeFrom(T bot) { return default(C5.IDirectedEnumerable<T>); }
    public C5.IDirectedEnumerable<T> RangeFromTo(T bot, T top) { return default(C5.IDirectedEnumerable<T>); }
    public C5.IDirectedEnumerable<T> RangeTo(T top) { return default(C5.IDirectedEnumerable<T>); }
    public void RemoveRangeFrom(T low) { }
    public void RemoveRangeFromTo(T low, T hi) { }
    public void RemoveRangeTo(T hi) { }
    public T Successor(T item) { return default(T); }
    public bool TryPredecessor(T item, out T res) { res = default(T); return default(bool); }
    public bool TrySuccessor(T item, out T res) { res = default(T); return default(bool); }
    public bool TryWeakPredecessor(T item, out T res) { res = default(T); return default(bool); }
    public bool TryWeakSuccessor(T item, out T res) { res = default(T); return default(bool); }
    public T WeakPredecessor(T item) { return default(T); }
    public T WeakSuccessor(T item) { return default(T); }
  }
  public partial class GuardedSortedDictionary<K, V> : C5.GuardedDictionary<K, V>, C5.ICollectionValue<C5.KeyValuePair<K, V>>, C5.IDictionary<K, V>, C5.IShowable, C5.ISortedDictionary<K, V>, System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public System.Collections.Generic.IComparer<K> Comparer { get { return default(System.Collections.Generic.IComparer<K>); } }
    public new C5.ISorted<K> Keys { get { return default(C5.ISorted<K>); } }
    public void AddSorted(System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>> items) { }
    public bool Cut(System.IComparable<K> c, out C5.KeyValuePair<K, V> lowEntry, out bool lowIsValid, out C5.KeyValuePair<K, V> highEntry, out bool highIsValid) { lowEntry = default(C5.KeyValuePair<K, V>); lowIsValid = default(bool); highEntry = default(C5.KeyValuePair<K, V>); highIsValid = default(bool); return default(bool); }
    public C5.KeyValuePair<K, V> DeleteMax() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> DeleteMin() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> FindMax() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> FindMin() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> Predecessor(K key) { return default(C5.KeyValuePair<K, V>); }
    public C5.IDirectedCollectionValue<C5.KeyValuePair<K, V>> RangeAll() { return default(C5.IDirectedCollectionValue<C5.KeyValuePair<K, V>>); }
    public C5.IDirectedEnumerable<C5.KeyValuePair<K, V>> RangeFrom(K bot) { return default(C5.IDirectedEnumerable<C5.KeyValuePair<K, V>>); }
    public C5.IDirectedEnumerable<C5.KeyValuePair<K, V>> RangeFromTo(K bot, K top) { return default(C5.IDirectedEnumerable<C5.KeyValuePair<K, V>>); }
    public C5.IDirectedEnumerable<C5.KeyValuePair<K, V>> RangeTo(K top) { return default(C5.IDirectedEnumerable<C5.KeyValuePair<K, V>>); }
    public void RemoveRangeFrom(K low) { }
    public void RemoveRangeFromTo(K low, K hi) { }
    public void RemoveRangeTo(K hi) { }
    public C5.KeyValuePair<K, V> Successor(K key) { return default(C5.KeyValuePair<K, V>); }
    public bool TryPredecessor(K key, out C5.KeyValuePair<K, V> res) { res = default(C5.KeyValuePair<K, V>); return default(bool); }
    public bool TrySuccessor(K key, out C5.KeyValuePair<K, V> res) { res = default(C5.KeyValuePair<K, V>); return default(bool); }
    public bool TryWeakPredecessor(K key, out C5.KeyValuePair<K, V> res) { res = default(C5.KeyValuePair<K, V>); return default(bool); }
    public bool TryWeakSuccessor(K key, out C5.KeyValuePair<K, V> res) { res = default(C5.KeyValuePair<K, V>); return default(bool); }
    public C5.KeyValuePair<K, V> WeakPredecessor(K key) { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> WeakSuccessor(K key) { return default(C5.KeyValuePair<K, V>); }
  }
  ...
  public partial class HashedLinkedList<T> : C5.SequencedBase<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IList<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IEnumerable, System.Collections.IList, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    public virtual T this[int index] { [C5.TestedAttribute]get { return default(T); } [C5.TestedAttribute]set { } }
    [C5.TestedAttribute]
    public C5.IDirectedCollectionValue<T> this[int start, int count] { [C5.TestedAttribute]get { return default(C5.IDirectedCollectionValue<T>); } }
    [C5.TestedAttribute]
    public virtual T Last { [C5.TestedAttribute]get { return default(T); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    ...
    public virtual int ContainsCount(T item) { return default(int); }
    public virtual void Dispose() { }
    public override System.Collections.Generic.IEnumerable<T> Filter(C5.Fun<T, System.Boolean> filter) { return default(System.Collections.Generic.IEnumerable<T>); }
    [C5.TestedAttribute]
    public virtual bool Find(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public C5.IList<T> FindAll(C5.Fun<T, System.Boolean> filter) { return default(C5.IList<T>); }
    ...
    public override System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
    [C5.TestedAttribute]
    public override int GetSequencedHashCode() { return default(int); }
    [C5.TestedAttribute]
    public override int GetUnsequencedHashCode() { return default(int); }
    [C5.TestedAttribute]
    public virtual int IndexOf(T item) { return default(int); }
    ...
    [C5.TestedAttribute]
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper) { return default(C5.IList<V>); }
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper, System.Collections.Generic.IEqualityComparer<V> equalityComparer) { return default(C5.IList<V>); }
    protected override void modifycheck(int stamp) { }
    [C5.TestedAttribute]
    public virtual T Remove() { return default(T); }
    [C5.TestedAttribute]
    ...
    public virtual void RemoveAllCopies(T item) { }
    [C5.TestedAttribute]
    public virtual T RemoveAt(int i) { return default(T); }
    [C5.TestedAttribute]
    public virtual T RemoveFirst() { return default(T); }
    [C5.TestedAttribute]
    public virtual void RemoveInterval(int start, int count) { }
    ...
    public virtual void Reverse() { }
    [C5.TestedAttribute]
    public override bool SequencedEquals(C5.ISequenced<T> that) { return default(bool); }
    public virtual void Shuffle() { }
    public virtual void Shuffle(System.Random rnd) { }
    [C5.TestedAttribute]
    public C5.IList<T> Slide(int offset) { return default(C5.IList<T>); }
  ...
  public partial class HashSet<T> : C5.CollectionBase<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IExtensible<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public virtual C5.Speed ContainsSpeed { [C5.TestedAttribute]get { return default(C5.Speed); } }
    public virtual bool DuplicatesByCounting { get { return default(bool); } }
    public static C5.HashSet<T>.Feature Features { get { return default(C5.HashSet<T>.Feature); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    public virtual bool Add(T item) { return default(bool); }
    [C5.TestedAttribute]
    ...
    public C5.ISortedDictionary<System.Int32, System.Int32> BucketCostDistribution() { return default(C5.ISortedDictionary<System.Int32, System.Int32>); }
    [C5.TestedAttribute]
    public virtual bool Check() { return default(bool); }
    [C5.TestedAttribute]
    public override T Choose() { return default(T); }
  ...
  public partial interface ICollection<T> : C5.ICollectionValue<T>, C5.IExtensible<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>> ItemMultiplicities();
  ...
  public partial interface ICollectionValue<T> : C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    bool All(C5.Fun<T, System.Boolean> predicate);
    void Apply(C5.Act<T> action);
    T Choose();
    void CopyTo(T[] array, int index);
    bool Exists(C5.Fun<T, System.Boolean> predicate);
    System.Collections.Generic.IEnumerable<T> Filter(C5.Fun<T, System.Boolean> filter);
    bool Find(C5.Fun<T, System.Boolean> predicate, out T item);
    T[] ToArray();
  }
  ...
  public partial interface IDirectedCollectionValue<T> : C5.ICollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    bool FindLast(C5.Fun<T, System.Boolean> predicate, out T item);
  }
  ...
  public partial interface IIndexed<T> : C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    int FindIndex(C5.Fun<T, System.Boolean> predicate);
    int FindLastIndex(C5.Fun<T, System.Boolean> predicate);
    int IndexOf(T item);
  ...
  public partial interface IIndexedSorted<T> : C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.ISequenced<T>, C5.IShowable, C5.ISorted<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    int CountTo(T top);
    C5.IIndexedSorted<T> FindAll(C5.Fun<T, System.Boolean> predicate);
  ...
  public partial interface IList<T> : C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IEnumerable, System.Collections.IList, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    new bool Contains(T item);
    new void CopyTo(T[] array, int index);
    C5.IList<T> FindAll(C5.Fun<T, System.Boolean> filter);
  ...
  public partial class IntEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Int32> {
    internal IntEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.IntEqualityComparer Default { get { return default(C5.IntEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(int item1, int item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(int item) { return default(int); }
  }
  ...
  public partial class IntervalHeap<T> : C5.CollectionValueBase<T>, C5.ICollectionValue<T>, C5.IExtensible<T>, C5.IPriorityQueue<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    [C5.TestedAttribute]
    public bool AllowsDuplicates { [C5.TestedAttribute]get { return default(bool); } }
    public System.Collections.Generic.IComparer<T> Comparer { get { return default(System.Collections.Generic.IComparer<T>); } }
    [C5.TestedAttribute]
    public override int Count { [C5.TestedAttribute]get { return default(int); } }
    public override C5.Speed CountSpeed { get { return default(C5.Speed); } }
    ...
    public bool IsReadOnly { get { return default(bool); } }
    [C5.TestedAttribute]
    public T this[C5.IPriorityQueueHandle<T> handle] { get { return default(T); } set { } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    public bool Add(T item) { return default(bool); }
    [C5.TestedAttribute]
    public bool Add(ref C5.IPriorityQueueHandle<T> handle, T item) { return default(bool); }
    [C5.TestedAttribute]
    ...
    public virtual object Clone() { return default(object); }
    [C5.TestedAttribute]
    public T Delete(C5.IPriorityQueueHandle<T> handle) { return default(T); }
    [C5.TestedAttribute]
    public T DeleteMax() { return default(T); }
    public T DeleteMax(out C5.IPriorityQueueHandle<T> handle) { handle = default(C5.IPriorityQueueHandle<T>); return default(T); }
    [C5.TestedAttribute]
    public T DeleteMin() { return default(T); }
    public T DeleteMin(out C5.IPriorityQueueHandle<T> handle) { handle = default(C5.IPriorityQueueHandle<T>); return default(T); }
    public bool Find(C5.IPriorityQueueHandle<T> handle, out T item) { item = default(T); return default(bool); }
    [C5.TestedAttribute]
    public T FindMax() { return default(T); }
    public T FindMax(out C5.IPriorityQueueHandle<T> handle) { handle = default(C5.IPriorityQueueHandle<T>); return default(T); }
    [C5.TestedAttribute]
    public T FindMin() { return default(T); }
    public T FindMin(out C5.IPriorityQueueHandle<T> handle) { handle = default(C5.IPriorityQueueHandle<T>); return default(T); }
    [C5.TestedAttribute]
    [System.Diagnostics.DebuggerHiddenAttribute]
    public override System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
    [C5.TestedAttribute]
    public T Replace(C5.IPriorityQueueHandle<T> handle, T item) { return default(T); }
  }
  ...
  public partial struct KeyValuePair<K, V> : C5.IShowable, System.IEquatable<C5.KeyValuePair<K, V>>, System.IFormattable {
    public K Key;
    public V Value;
    public KeyValuePair(K key) { throw new System.NotImplementedException(); }
    public KeyValuePair(K key, V value) { throw new System.NotImplementedException(); }
    public bool Equals(C5.KeyValuePair<K, V> other) { return default(bool); }
    [C5.TestedAttribute]
    public override bool Equals(object obj) { return default(bool); }
    [C5.TestedAttribute]
    public override int GetHashCode() { return default(int); }
    public static bool operator ==(C5.KeyValuePair<K, V> pair1, C5.KeyValuePair<K, V> pair2) { return default(bool); }
    public static bool operator !=(C5.KeyValuePair<K, V> pair1, C5.KeyValuePair<K, V> pair2) { return default(bool); }
    public bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    [C5.TestedAttribute]
    public override string ToString() { return default(string); }
  ...
  public partial class KeyValuePairComparer<K, V> : System.Collections.Generic.IComparer<C5.KeyValuePair<K, V>> {
    ...
    [C5.TestedAttribute]
    public int Compare(C5.KeyValuePair<K, V> entry1, C5.KeyValuePair<K, V> entry2) { return default(int); }
  }
  public sealed partial class KeyValuePairEqualityComparer<K, V> : System.Collections.Generic.IEqualityComparer<C5.KeyValuePair<K, V>> {
    ...
    [C5.TestedAttribute]
    public bool Equals(C5.KeyValuePair<K, V> entry1, C5.KeyValuePair<K, V> entry2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(C5.KeyValuePair<K, V> entry) { return default(int); }
  }
  ...
  public partial class LongEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Int64> {
    internal LongEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.LongEqualityComparer Default { get { return default(C5.LongEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(long item1, long item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(long item) { return default(int); }
  }
  ...
  public sealed partial class NaturalEqualityComparer<T> : System.Collections.Generic.IEqualityComparer<T> {
    ...
    public static C5.NaturalEqualityComparer<T> Default { get { return default(C5.NaturalEqualityComparer<T>); } }
    [C5.TestedAttribute]
    public bool Equals(T item1, T item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(T item) { return default(int); }
  ...
  public partial struct Rec<T1, T2> : C5.IShowable, System.IEquatable<C5.Rec<T1, T2>>, System.IFormattable {
    ...
    [C5.TestedAttribute]
    public Rec(T1 x1, T2 x2) { throw new System.NotImplementedException(); }
    [C5.TestedAttribute]
    public bool Equals(C5.Rec<T1, T2> other) { return default(bool); }
    [C5.TestedAttribute]
    public override bool Equals(object obj) { return default(bool); }
    [C5.TestedAttribute]
    public override int GetHashCode() { return default(int); }
    [C5.TestedAttribute]
    public static bool operator ==(C5.Rec<T1, T2> record1, C5.Rec<T1, T2> record2) { return default(bool); }
    [C5.TestedAttribute]
    public static bool operator !=(C5.Rec<T1, T2> record1, C5.Rec<T1, T2> record2) { return default(bool); }
    public bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public override string ToString() { return default(string); }
  ...
  public partial struct Rec<T1, T2, T3> : C5.IShowable, System.IEquatable<C5.Rec<T1, T2, T3>>, System.IFormattable {
    ...
    [C5.TestedAttribute]
    public Rec(T1 x1, T2 x2, T3 x3) { throw new System.NotImplementedException(); }
    [C5.TestedAttribute]
    public bool Equals(C5.Rec<T1, T2, T3> other) { return default(bool); }
    [C5.TestedAttribute]
    public override bool Equals(object obj) { return default(bool); }
    [C5.TestedAttribute]
    public override int GetHashCode() { return default(int); }
    [C5.TestedAttribute]
    public static bool operator ==(C5.Rec<T1, T2, T3> record1, C5.Rec<T1, T2, T3> record2) { return default(bool); }
    [C5.TestedAttribute]
    public static bool operator !=(C5.Rec<T1, T2, T3> record1, C5.Rec<T1, T2, T3> record2) { return default(bool); }
    public bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public override string ToString() { return default(string); }
  ...
  public partial struct Rec<T1, T2, T3, T4> : C5.IShowable, System.IEquatable<C5.Rec<T1, T2, T3, T4>>, System.IFormattable {
    ...
    [C5.TestedAttribute]
    public Rec(T1 x1, T2 x2, T3 x3, T4 x4) { throw new System.NotImplementedException(); }
    [C5.TestedAttribute]
    public bool Equals(C5.Rec<T1, T2, T3, T4> other) { return default(bool); }
    [C5.TestedAttribute]
    public override bool Equals(object obj) { return default(bool); }
    [C5.TestedAttribute]
    public override int GetHashCode() { return default(int); }
    [C5.TestedAttribute]
    public static bool operator ==(C5.Rec<T1, T2, T3, T4> record1, C5.Rec<T1, T2, T3, T4> record2) { return default(bool); }
    [C5.TestedAttribute]
    public static bool operator !=(C5.Rec<T1, T2, T3, T4> record1, C5.Rec<T1, T2, T3, T4> record2) { return default(bool); }
    public bool Show(System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public override string ToString() { return default(string); }
  ...
  public partial class ReferenceEqualityComparer<T> : System.Collections.Generic.IEqualityComparer<T> where T : class {
    ...
    public static C5.ReferenceEqualityComparer<T> Default { get { return default(C5.ReferenceEqualityComparer<T>); } }
    public bool Equals(T i1, T i2) { return default(bool); }
    public int GetHashCode(T item) { return default(int); }
  }
  public partial class SByteEqualityComparer : System.Collections.Generic.IEqualityComparer<System.SByte> {
    internal SByteEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.SByteEqualityComparer Default { get { return default(C5.SByteEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(sbyte item1, sbyte item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(sbyte item) { return default(int); }
  }
  public abstract partial class SequencedBase<T> : C5.DirectedCollectionBase<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IShowable, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.IFormattable {
    ...
    public override C5.EnumerationDirection Direction { [C5.TestedAttribute]get { return default(C5.EnumerationDirection); } }
    [C5.TestedAttribute]
    public static int ComputeHashCode(C5.ISequenced<T> items, System.Collections.Generic.IEqualityComparer<T> itemequalityComparer) { return default(int); }
    public int FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public int FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public abstract override System.Collections.Generic.IEnumerator<T> GetEnumerator();
    public virtual int GetSequencedHashCode() { return default(int); }
    public virtual bool SequencedEquals(C5.ISequenced<T> otherCollection) { return default(bool); }
    [C5.TestedAttribute]
    public static bool StaticEquals(C5.ISequenced<T> collection1, C5.ISequenced<T> collection2, System.Collections.Generic.IEqualityComparer<T> itemequalityComparer) { return default(bool); }
  }
  public partial class SequencedCollectionEqualityComparer<T, W> : System.Collections.Generic.IEqualityComparer<T> where T : C5.ISequenced<W> {
    ...
    public static C5.SequencedCollectionEqualityComparer<T, W> Default { get { return default(C5.SequencedCollectionEqualityComparer<T, W>); } }
    [C5.TestedAttribute]
    public bool Equals(T collection1, T collection2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(T collection) { return default(int); }
  }
  public partial class ShortEqualityComparer : System.Collections.Generic.IEqualityComparer<System.Int16> {
    internal ShortEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.ShortEqualityComparer Default { get { return default(C5.ShortEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(short item1, short item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(short item) { return default(int); }
  }
  public static partial class Showing {
    public static bool Show(object obj, System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public static bool ShowCollectionValue<T>(C5.ICollectionValue<T> items, System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public static bool ShowDictionary<K, V>(C5.IDictionary<K, V> dictionary, System.Text.StringBuilder stringbuilder, ref int rest, System.IFormatProvider formatProvider) { return default(bool); }
    public static string ShowString(C5.IShowable showable, string format, System.IFormatProvider formatProvider) { return default(string); }
  }
  public partial class SortedArray<T> : C5.ArrayBase<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IIndexedSorted<T>, C5.ISequenced<T>, C5.IShowable, C5.ISorted<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public System.Collections.Generic.IComparer<T> Comparer { get { return default(System.Collections.Generic.IComparer<T>); } }
    [C5.TestedAttribute]
    public C5.Speed ContainsSpeed { [C5.TestedAttribute]get { return default(C5.Speed); } }
    public virtual bool DuplicatesByCounting { get { return default(bool); } }
    public static C5.SortedArray<T>.Feature Features { get { return default(C5.SortedArray<T>.Feature); } }
    public virtual C5.Speed IndexingSpeed { get { return default(C5.Speed); } }
    [C5.TestedAttribute]
    public T this[int i] { [C5.TestedAttribute]get { return default(T); } }
    public override C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    [C5.TestedAttribute]
    public bool Add(T item) { return default(bool); }
    [C5.TestedAttribute]
    ...
    int C5.IIndexed.FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    int C5.IIndexed.FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    C5.IDirectedEnumerable<T> C5.ISorted<T>.RangeFrom(T bot) { return default(C5.IDirectedEnumerable<T>); }
    C5.IDirectedEnumerable<T> C5.ISorted<T>.RangeFromTo(T bot, T top) { return default(C5.IDirectedEnumerable<T>); }
    C5.IDirectedEnumerable<T> C5.ISorted<T>.RangeTo(T top) { return default(C5.IDirectedEnumerable<T>); }
    [C5.TestedAttribute]
    public override bool Check() { return default(bool); }
    [C5.TestedAttribute]
    public override void Clear() { }
    ...
    [C5.TestedAttribute]
    public bool ContainsAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { return default(bool); }
    [C5.TestedAttribute]
    public int ContainsCount(T item) { return default(int); }
    [C5.TestedAttribute]
    public int CountFrom(T bot) { return default(int); }
    [C5.TestedAttribute]
    public int CountFromTo(T bot, T top) { return default(int); }
    ...
    public int CountTo(T top) { return default(int); }
    [C5.TestedAttribute]
    public bool Cut(System.IComparable<T> c, out T low, out bool lowIsValid, out T high, out bool highIsValid) { low = default(T); lowIsValid = default(bool); high = default(T); highIsValid = default(bool); return default(bool); }
    [C5.TestedAttribute]
    public T DeleteMax() { return default(T); }
    [C5.TestedAttribute]
    public T DeleteMin() { return default(T); }
    [C5.TestedAttribute]
    public bool Find(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public C5.IIndexedSorted<T> FindAll(C5.Fun<T, System.Boolean> f) { return default(C5.IIndexedSorted<T>); }
    [C5.TestedAttribute]
    public T FindMax() { return default(T); }
    ...
    public T FindMin() { return default(T); }
    [C5.TestedAttribute]
    public bool FindOrAdd(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public int IndexOf(T item) { return default(int); }
    public virtual C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>> ItemMultiplicities() { return default(C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>>); }
    [C5.TestedAttribute]
    ...
    public C5.IDirectedCollectionValue<T> RangeAll() { return default(C5.IDirectedCollectionValue<T>); }
    [C5.TestedAttribute]
    public C5.IDirectedCollectionValue<T> RangeFrom(T bot) { return default(C5.IDirectedCollectionValue<T>); }
    [C5.TestedAttribute]
    public C5.IDirectedCollectionValue<T> RangeFromTo(T bot, T top) { return default(C5.IDirectedCollectionValue<T>); }
    [C5.TestedAttribute]
    public C5.IDirectedCollectionValue<T> RangeTo(T top) { return default(C5.IDirectedCollectionValue<T>); }
    [C5.TestedAttribute]
    public bool Remove(T item) { return default(bool); }
    [C5.TestedAttribute]
    public bool Remove(T item, out T removeditem) { removeditem = default(T); return default(bool); }
    [C5.TestedAttribute]
    ...
    public virtual C5.ICollectionValue<T> UniqueItems() { return default(C5.ICollectionValue<T>); }
    [C5.TestedAttribute]
    public bool Update(T item) { return default(bool); }
    public bool Update(T item, out T olditem) { olditem = default(T); return default(bool); }
    [C5.TestedAttribute]
    public bool UpdateOrAdd(T item) { return default(bool); }
    public bool UpdateOrAdd(T item, out T olditem) { olditem = default(T); return default(bool); }
    [C5.TestedAttribute]
    public T WeakPredecessor(T item) { return default(T); }
    [C5.TestedAttribute]
    public T WeakSuccessor(T item) { return default(T); }
  ...
  public abstract partial class SortedDictionaryBase<K, V> : C5.DictionaryBase<K, V>, C5.ICollectionValue<C5.KeyValuePair<K, V>>, C5.IDictionary<K, V>, C5.IShowable, C5.ISortedDictionary<K, V>, System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public new C5.ISorted<K> Keys { get { return default(C5.ISorted<K>); } }
    public void AddSorted(System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>> items) { }
    public bool Cut(System.IComparable<K> cutter, out C5.KeyValuePair<K, V> lowEntry, out bool lowIsValid, out C5.KeyValuePair<K, V> highEntry, out bool highIsValid) { lowEntry = default(C5.KeyValuePair<K, V>); lowIsValid = default(bool); highEntry = default(C5.KeyValuePair<K, V>); highIsValid = default(bool); return default(bool); }
    public C5.KeyValuePair<K, V> DeleteMax() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> DeleteMin() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> FindMax() { return default(C5.KeyValuePair<K, V>); }
    public C5.KeyValuePair<K, V> FindMin() { return default(C5.KeyValuePair<K, V>); }
  ...
  public partial class TreeBag<T> : C5.SequencedBase<T>, C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IIndexedSorted<T>, C5.IPersistentSorted<T>, C5.ISequenced<T>, C5.IShowable, C5.ISorted<T>, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.IEnumerable, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    public bool Check(string name) { return default(bool); }
    [C5.TestedAttribute]
    public override T Choose() { return default(T); }
    [C5.TestedAttribute]
    public void Clear() { }
    ...
    public bool Find(ref T item) { return default(bool); }
    [C5.TestedAttribute]
    public C5.IIndexedSorted<T> FindAll(C5.Fun<T, System.Boolean> filter) { return default(C5.IIndexedSorted<T>); }
    [C5.TestedAttribute]
    public T FindMax() { return default(T); }
    [C5.TestedAttribute]
    public T FindMin() { return default(T); }
    ...
    public int LastIndexOf(T item) { return default(int); }
    [C5.TestedAttribute]
    public C5.IIndexedSorted<V> Map<V>(C5.Fun<T, V> mapper, System.Collections.Generic.IComparer<V> c) { return default(C5.IIndexedSorted<V>); }
    [C5.TestedAttribute]
    public T Predecessor(T item) { return default(T); }
    [C5.TestedAttribute]
    public C5.IDirectedCollectionValue<T> RangeAll() { return default(C5.IDirectedCollectionValue<T>); }
    ...
    public void RetainAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { }
    [C5.TestedAttribute]
    public C5.ISorted<T> Snapshot() { return default(C5.ISorted<T>); }
    [C5.TestedAttribute]
    public T Successor(T item) { return default(T); }
    [C5.TestedAttribute]
    void System.Collections.Generic.ICollection<T>.Add(T item) { }
  ...
  public partial class TreeDictionary<K, V> : C5.SortedDictionaryBase<K, V>, C5.ICollectionValue<C5.KeyValuePair<K, V>>, C5.IDictionary<K, V>, C5.IShowable, C5.ISortedDictionary<K, V>, System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>, System.Collections.IEnumerable, System.ICloneable, System.IFormattable {
    ...
    public override object Clone() { return default(object); }
    [C5.TestedAttribute]
    public System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>> Snapshot() { return default(System.Collections.Generic.IEnumerable<C5.KeyValuePair<K, V>>); }
  }
  ...
  public partial class UIntEqualityComparer : System.Collections.Generic.IEqualityComparer<System.UInt32> {
    internal UIntEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.UIntEqualityComparer Default { get { return default(C5.UIntEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(uint item1, uint item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(uint item) { return default(int); }
  }
  public partial class ULongEqualityComparer : System.Collections.Generic.IEqualityComparer<System.UInt64> {
    internal ULongEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.ULongEqualityComparer Default { get { return default(C5.ULongEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(ulong item1, ulong item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(ulong item) { return default(int); }
  }
  ...
  public partial class UnsequencedCollectionEqualityComparer<T, W> : System.Collections.Generic.IEqualityComparer<T> where T : C5.ICollection<W> {
    ...
    public static C5.UnsequencedCollectionEqualityComparer<T, W> Default { get { return default(C5.UnsequencedCollectionEqualityComparer<T, W>); } }
    [C5.TestedAttribute]
    public bool Equals(T collection1, T collection2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(T collection) { return default(int); }
  }
  public partial class UShortEqualityComparer : System.Collections.Generic.IEqualityComparer<System.UInt16> {
    internal UShortEqualityComparer() { }
    [C5.TestedAttribute]
    public static C5.UShortEqualityComparer Default { get { return default(C5.UShortEqualityComparer); } }
    [C5.TestedAttribute]
    public bool Equals(ushort item1, ushort item2) { return default(bool); }
    [C5.TestedAttribute]
    public int GetHashCode(ushort item) { return default(int); }
  }
  ...
  public partial class WrappedArray<T> : C5.ICollection<T>, C5.ICollectionValue<T>, C5.IDirectedCollectionValue<T>, C5.IDirectedEnumerable<T>, C5.IExtensible<T>, C5.IIndexed<T>, C5.IList<T>, C5.ISequenced<T>, C5.IShowable, System.Collections.Generic.ICollection<T>, System.Collections.Generic.IEnumerable<T>, System.Collections.Generic.IList<T>, System.Collections.ICollection, System.Collections.IEnumerable, System.Collections.IList, System.ICloneable, System.IDisposable, System.IFormattable {
    ...
    public C5.Speed CountSpeed { get { return default(C5.Speed); } }
    public C5.EnumerationDirection Direction { get { return default(C5.EnumerationDirection); } }
    public bool DuplicatesByCounting { get { return default(bool); } }
    public System.Collections.Generic.IEqualityComparer<T> EqualityComparer { get { return default(System.Collections.Generic.IEqualityComparer<T>); } }
    public bool FIFO { get { return default(bool); } set { } }
    public T First { get { return default(T); } }
    public C5.Speed IndexingSpeed { get { return default(C5.Speed); } }
    ...
    public C5.IDirectedCollectionValue<T> this[int start, int count] { get { return default(C5.IDirectedCollectionValue<T>); } }
    public T Last { get { return default(T); } }
    public virtual C5.EventTypeEnum ListenableEvents { get { return default(C5.EventTypeEnum); } }
    public int Offset { get { return default(int); } }
    bool System.Collections.ICollection.IsSynchronized { get { return default(bool); } }
    ...
    public bool Add(T item) { return default(bool); }
    public void AddAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { }
    public bool All(C5.Fun<T, System.Boolean> predicate) { return default(bool); }
    public void Apply(C5.Act<T> action) { }
    public C5.IDirectedCollectionValue<T> Backwards() { return default(C5.IDirectedCollectionValue<T>); }
    C5.IDirectedEnumerable<T> C5.IDirectedEnumerable<T>.Backwards() { return default(C5.IDirectedEnumerable<T>); }
    public bool Check() { return default(bool); }
    public T Choose() { return default(T); }
    public void Clear() { }
    public virtual object Clone() { return default(object); }
    public bool Contains(T item) { return default(bool); }
    public bool ContainsAll<U>(System.Collections.Generic.IEnumerable<U> items) where U : T { return default(bool); }
    ...
    public void Dispose() { }
    public bool Exists(C5.Fun<T, System.Boolean> predicate) { return default(bool); }
    public System.Collections.Generic.IEnumerable<T> Filter(C5.Fun<T, System.Boolean> filter) { return default(System.Collections.Generic.IEnumerable<T>); }
    public bool Find(ref T item) { return default(bool); }
    public bool Find(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
    public C5.IList<T> FindAll(C5.Fun<T, System.Boolean> filter) { return default(C5.IList<T>); }
    public int FindIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public bool FindLast(C5.Fun<T, System.Boolean> predicate, out T item) { item = default(T); return default(bool); }
    public int FindLastIndex(C5.Fun<T, System.Boolean> predicate) { return default(int); }
    public bool FindOrAdd(ref T item) { return default(bool); }
    public System.Collections.Generic.IEnumerator<T> GetEnumerator() { return default(System.Collections.Generic.IEnumerator<T>); }
    public int GetSequencedHashCode() { return default(int); }
    public int GetUnsequencedHashCode() { return default(int); }
    public int IndexOf(T item) { return default(int); }
    public void Insert(C5.IList<T> pointer, T item) { }
    public void Insert(int index, T item) { }
    public void InsertAll<U>(int i, System.Collections.Generic.IEnumerable<U> items) where U : T { }
    ...
    public void InsertLast(T item) { }
    public bool IsSorted() { return default(bool); }
    public bool IsSorted(System.Collections.Generic.IComparer<T> comparer) { return default(bool); }
    public C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>> ItemMultiplicities() { return default(C5.ICollectionValue<C5.KeyValuePair<T, System.Int32>>); }
    public int LastIndexOf(T item) { return default(int); }
    public C5.IList<T> LastViewOf(T item) { return default(C5.IList<T>); }
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper) { return default(C5.IList<V>); }
    public C5.IList<V> Map<V>(C5.Fun<T, V> mapper, System.Collections.Generic.IEqualityComparer<V> equalityComparer) { return default(C5.IList<V>); }
    ...
    public bool TrySlide(int offset) { return default(bool); }
    public bool TrySlide(int offset, int size) { return default(bool); }
    public C5.ICollectionValue<T> UniqueItems() { return default(C5.ICollectionValue<T>); }
    public bool UnsequencedEquals(C5.ICollection<T> that) { return default(bool); }
    public bool Update(T item) { return default(bool); }
    public bool Update(T item, out T olditem) { olditem = default(T); return default(bool); }
    public bool UpdateOrAdd(T item) { return default(bool); }
    public bool UpdateOrAdd(T item, out T olditem) { olditem = default(T); return default(bool); }
