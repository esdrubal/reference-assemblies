namespace Mono.Debugger.Soft {
  ...
  public partial class AssemblyMirror : Mono.Debugger.Soft.Mirror {
    ...
    public Mono.Cecil.AssemblyDefinition Metadata { get { return default(Mono.Cecil.AssemblyDefinition); } set { } }
  ...
  public partial class ObjectMirror : Mono.Debugger.Soft.Value {
    ...
    public System.Threading.Tasks.Task<Mono.Debugger.Soft.Value> InvokeMethodAsync(Mono.Debugger.Soft.ThreadMirror thread, Mono.Debugger.Soft.MethodMirror method, System.Collections.Generic.IList<Mono.Debugger.Soft.Value> arguments, Mono.Debugger.Soft.InvokeOptions options=(Mono.Debugger.Soft.InvokeOptions)(0)) { return default(System.Threading.Tasks.Task<Mono.Debugger.Soft.Value>); }
    public System.Threading.Tasks.Task<Mono.Debugger.Soft.InvokeResult> InvokeMethodAsyncWithResult(Mono.Debugger.Soft.ThreadMirror thread, Mono.Debugger.Soft.MethodMirror method, System.Collections.Generic.IList<Mono.Debugger.Soft.Value> arguments, Mono.Debugger.Soft.InvokeOptions options=(Mono.Debugger.Soft.InvokeOptions)(0)) { return default(System.Threading.Tasks.Task<Mono.Debugger.Soft.InvokeResult>); }
