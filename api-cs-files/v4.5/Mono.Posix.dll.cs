...
namespace Mono.Unix.Native {
  ...
  public sealed partial class NativeConvert {
    ...
    public static System.DateTime ToDateTime(long time, long nanoTime) { return default(System.DateTime); }
  ...
  public sealed partial class Syscall : Mono.Unix.Native.Stdlib {
    ...
    public static int fcntl(int fd, Mono.Unix.Native.FcntlCommand cmd, int arg) { return default(int); }
    public static int fcntl(int fd, Mono.Unix.Native.FcntlCommand cmd, long arg) { return default(int); }
    public static int fcntl(int fd, Mono.Unix.Native.FcntlCommand cmd, System.IntPtr ptr) { return default(int); }
