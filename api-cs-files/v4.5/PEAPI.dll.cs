namespace PEAPI {
  ...
  public partial class ArrayConstant : PEAPI.DataConstant {
    ...
    public System.Nullable<System.Int32> ExplicitSize { [System.Runtime.CompilerServices.CompilerGeneratedAttribute]get { return default(System.Nullable<System.Int32>); } [System.Runtime.CompilerServices.CompilerGeneratedAttribute]set { } }
  }
  ...
  public partial class Assembly : PEAPI.ResolutionScope {
    ...
    public void AddAssemblyInfo(int majVer, int minVer, int bldNo, int revNo, System.Byte[] key, uint hash, string cult) { }
  }
  public partial class AssemblyRef : PEAPI.ResolutionScope, PEAPI.IExternRef {
    internal AssemblyRef() { }
    public void AddAssemblyAttr(PEAPI.AssemAttr aa) { }
    public virtual PEAPI.ClassRef AddClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public void AddCulture(string cult) { }
    public void AddHash(System.Byte[] hash) { }
    public void AddKey(System.Byte[] key) { }
    public void AddKeyToken(System.Byte[] key) { }
    public virtual PEAPI.ClassRef AddValueClass(string nsName, string name) { return default(PEAPI.ClassRef); }
  ...
  public partial class BoundArray : PEAPI.Array {
    ...
    public BoundArray(PEAPI.Type elementType, uint dimensions, System.Int32[] size) { }
    public BoundArray(PEAPI.Type elementType, uint dimensions, System.Int32[] loBounds, System.Int32[] sizes) { }
  }
  ...
  public partial class ByteArrConst : PEAPI.DataConstant {
    public ByteArrConst(System.Byte[] val) { }
    public PEAPI.Type Type { get { return default(PEAPI.Type); } set { } }
  }
  ...
  public partial class CILInstructions {
    ...
    public uint Offset { get { return default(uint); } }
    ...
    public PEAPI.TryBlock EndTryBlock() { return default(PEAPI.TryBlock); }
    ...
    public void ldstr(System.Byte[] str) { }
    ...
    public PEAPI.CILLabel NewCodedLabel() { return default(PEAPI.CILLabel); }
    public PEAPI.CILLabel NewLabel() { return default(PEAPI.CILLabel); }
  ...
  public partial class ClassDef : PEAPI.Class {
    ...
    public PEAPI.Event AddEvent(string name, PEAPI.Type eType) { return default(PEAPI.Event); }
    public PEAPI.FieldDef AddField(PEAPI.FieldAttr fAtts, string name, PEAPI.Type fType) { return default(PEAPI.FieldDef); }
    public PEAPI.FieldDef AddField(string name, PEAPI.Type fType) { return default(PEAPI.FieldDef); }
    public PEAPI.GenericParameter AddGenericParameter(short index, string name) { return default(PEAPI.GenericParameter); }
    public PEAPI.GenericParameter AddGenericParameter(short index, string name, PEAPI.GenericParamAttributes attr) { return default(PEAPI.GenericParameter); }
    public void AddImplementedInterface(PEAPI.Class iFace) { }
    public void AddLayoutInfo(int packSize, int classSize) { }
    public PEAPI.MethodDef AddMethod(PEAPI.MethAttr mAtts, PEAPI.ImplAttr iAtts, string name, PEAPI.Param ret_param, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.MethodDef AddMethod(string name, PEAPI.Param ret_param, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.MethodDef AddMethod(string name, PEAPI.Type retType, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public void AddMethodOverride(PEAPI.Method decl, PEAPI.Method body) { }
    public PEAPI.ClassDef AddNestedClass(PEAPI.TypeAttr attrSet, string nsName, string name) { return default(PEAPI.ClassDef); }
    public PEAPI.ClassDef AddNestedClass(PEAPI.TypeAttr attrSet, string nsName, string name, PEAPI.Class sType) { return default(PEAPI.ClassDef); }
    public PEAPI.Property AddProperty(string name, PEAPI.Type retType, PEAPI.Type[] pars) { return default(PEAPI.Property); }
    public void AddSecurity(System.Byte[] permissionSet) { }
    public static bool IsEnum(PEAPI.Class type) { return default(bool); }
    public static bool IsEnum(string nsName, string name) { return default(bool); }
    public static bool IsValueType(PEAPI.Class type) { return default(bool); }
    public static bool IsValueType(string nsName, string name) { return default(bool); }
  ...
  public partial class ClassRef : PEAPI.Class, PEAPI.IExternRef, PEAPI.IResolutionScope {
    ...
    public PEAPI.ClassRef AddClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public PEAPI.FieldRef AddField(string name, PEAPI.Type fType) { return default(PEAPI.FieldRef); }
    public PEAPI.MethodRef AddMethod(string name, PEAPI.Type retType, PEAPI.Type[] pars) { return default(PEAPI.MethodRef); }
    public PEAPI.MethodRef AddMethod(string name, PEAPI.Type retType, PEAPI.Type[] pars, int gen_param_count) { return default(PEAPI.MethodRef); }
    public PEAPI.ClassRef AddValueClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public PEAPI.MethodRef AddVarArgMethod(string name, PEAPI.Type retType, PEAPI.Type[] pars, PEAPI.Type[] optPars) { return default(PEAPI.MethodRef); }
  }
  ...
  public abstract partial class DataConstant : PEAPI.Constant {
    ...
    public uint DataOffset { get { return default(uint); } set { } }
  }
  ...
  public partial class ExternClassRef : PEAPI.ClassRef {
    ...
    public PEAPI.ClassRef AddNestedClass(PEAPI.TypeAttr attrs, string name) { return default(PEAPI.ClassRef); }
  }
  ...
  public partial class GenParam : PEAPI.Class {
    ...
    public PEAPI.GenParamType Type { get { return default(PEAPI.GenParamType); } }
  }
  ...
  public partial class Hex {
    public Hex() { }
    public static string Byte(int b) { return default(string); }
    public static string Int(int val) { return default(string); }
    public static string Int(uint num) { return default(string); }
    public static string Long(long lnum) { return default(string); }
    public static string Short(int b) { return default(string); }
  }
  ...
  public partial class ManifestResource : PEAPI.MetaDataElement {
    ...
    public ManifestResource(string name, System.Byte[] resBytes, uint flags) { }
  ...
  public abstract partial class MetaDataElement : System.IComparable {
    ...
    public bool HasCustomAttr { get { return default(bool); } set { } }
    public uint Row { get { return default(uint); } set { } }
    public void AddCustomAttribute(PEAPI.Method ctorMeth, PEAPI.Constant[] cVals) { }
    public void AddCustomAttribute(PEAPI.Method ctorMeth, System.Byte[] val) { }
  ...
  public partial class MethodDef : PEAPI.Method {
    ...
    public PEAPI.CILInstructions CreateCodeBuffer() { return default(PEAPI.CILInstructions); }
    public void DeclareEntryPoint() { }
    public PEAPI.MethodRef MakeVarArgSignature(PEAPI.Type[] optPars) { return default(PEAPI.MethodRef); }
  ...
  public partial class ModuleRef : PEAPI.ResolutionScope, PEAPI.IExternRef {
    internal ModuleRef() { }
    public PEAPI.ClassRef AddClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public PEAPI.ExternClassRef AddExternClass(PEAPI.TypeAttr attrSet, string nsName, string name, PEAPI.FileRef declFile, bool isValueClass) { return default(PEAPI.ExternClassRef); }
    public PEAPI.FieldRef AddField(string name, PEAPI.Type fType) { return default(PEAPI.FieldRef); }
    public PEAPI.MethodRef AddMethod(string name, PEAPI.Type retType, PEAPI.Type[] pars) { return default(PEAPI.MethodRef); }
    public PEAPI.ClassRef AddValueClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public PEAPI.MethodRef AddVarArgMethod(string name, PEAPI.Type retType, PEAPI.Type[] pars, PEAPI.Type[] optPars) { return default(PEAPI.MethodRef); }
    public PEAPI.FileRef MakeFile(System.Byte[] hashBytes, bool hasMetaData, bool entryPoint) { return default(PEAPI.FileRef); }
  }
  public sealed partial class MSCorLib : PEAPI.AssemblyRef {
    internal MSCorLib() { }
    public override PEAPI.ClassRef AddClass(string nsName, string name) { return default(PEAPI.ClassRef); }
    public override PEAPI.ClassRef AddValueClass(string nsName, string name) { return default(PEAPI.ClassRef); }
  }
  ...
  public partial class PEFile {
    ...
    public PEAPI.ClassDef ModuleClass { get { return default(PEAPI.ClassDef); } }
    public PEAPI.ClassDef AddClass(PEAPI.TypeAttr attrSet, string nsName, string name) { return default(PEAPI.ClassDef); }
    public PEAPI.ClassDef AddClass(PEAPI.TypeAttr attrSet, string nsName, string name, PEAPI.Class superType) { return default(PEAPI.ClassDef); }
    public void AddCustomAttribute(PEAPI.Method meth, PEAPI.Constant constant, PEAPI.MetaDataElement element) { }
    public void AddCustomAttribute(PEAPI.Method meth, System.Byte[] data, PEAPI.MetaDataElement element) { }
    public void AddDeclSecurity(PEAPI.SecurityAction sec_action, PEAPI.PermissionSet ps, PEAPI.MetaDataElement element) { }
    public void AddDeclSecurity(PEAPI.SecurityAction sec_action, System.Byte[] data, PEAPI.MetaDataElement element) { }
    ...
    public PEAPI.AssemblyRef AddExternAssembly(string assemName) { return default(PEAPI.AssemblyRef); }
    public PEAPI.ClassRef AddExternClass(string ns, string name, PEAPI.TypeAttr attrs, PEAPI.MetaDataElement declRef) { return default(PEAPI.ClassRef); }
    public PEAPI.ModuleRef AddExternModule(string name) { return default(PEAPI.ModuleRef); }
    public PEAPI.FieldDef AddField(PEAPI.FieldAttr attrSet, string name, PEAPI.Type fType) { return default(PEAPI.FieldDef); }
    public PEAPI.FieldDef AddField(string name, PEAPI.Type fType) { return default(PEAPI.FieldDef); }
    public PEAPI.FieldRef AddFieldToTypeSpec(PEAPI.Type item, string name, PEAPI.Type fType) { return default(PEAPI.FieldRef); }
    public PEAPI.FileRef AddFile(string fName, System.Byte[] hashBytes, bool hasMetaData, bool entryPoint) { return default(PEAPI.FileRef); }
    ...
    public PEAPI.MethodDef AddMethod(PEAPI.MethAttr mAtts, PEAPI.ImplAttr iAtts, string name, PEAPI.Param ret_param, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.MethodDef AddMethod(PEAPI.MethAttr mAtts, PEAPI.ImplAttr iAtts, string name, PEAPI.Type retType, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.MethodDef AddMethod(string name, PEAPI.Param ret_param, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.MethodDef AddMethod(string name, PEAPI.Type retType, PEAPI.Param[] pars) { return default(PEAPI.MethodDef); }
    public PEAPI.Method AddMethodSpec(PEAPI.Method m, PEAPI.GenericMethodSig g_sig) { return default(PEAPI.Method); }
    public PEAPI.MethodRef AddMethodToTypeSpec(PEAPI.Type item, string name, PEAPI.Type retType, PEAPI.Type[] pars) { return default(PEAPI.MethodRef); }
    public PEAPI.MethodRef AddMethodToTypeSpec(PEAPI.Type item, string name, PEAPI.Type retType, PEAPI.Type[] pars, int gen_param_count) { return default(PEAPI.MethodRef); }
    public PEAPI.PrimitiveTypeRef AddPrimitiveType(PEAPI.PrimitiveType type) { return default(PEAPI.PrimitiveTypeRef); }
    public PEAPI.ClassDef AddValueClass(PEAPI.TypeAttr attrSet, string nsName, string name, PEAPI.ValueClass vClass) { return default(PEAPI.ClassDef); }
    public PEAPI.MethodRef AddVarArgMethodToTypeSpec(PEAPI.Type item, string name, PEAPI.Type retType, PEAPI.Type[] pars, PEAPI.Type[] optPars) { return default(PEAPI.MethodRef); }
    public PEAPI.ManifestResource GetResource(string name) { return default(PEAPI.ManifestResource); }
    public PEAPI.ManifestResource[] GetResources() { return default(PEAPI.ManifestResource[]); }
    public PEAPI.Assembly GetThisAssembly() { return default(PEAPI.Assembly); }
    public PEAPI.Module GetThisModule() { return default(PEAPI.Module); }
