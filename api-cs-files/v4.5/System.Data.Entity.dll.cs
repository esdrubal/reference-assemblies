...
namespace System.Data.Entity {
  public static partial class Strings {
    public static string ADP_ClosedDataReaderError { get { return default(string); } }
    public static string ADP_GetSchemaTableIsNotSupported { get { return default(string); } }
    public static string ADP_ImplicitlyClosedDataReaderError { get { return default(string); } }
    public static string ADP_InvalidDataDirectory { get { return default(string); } }
    public static string ADP_InvalidDataReaderFieldCountForScalarType { get { return default(string); } }
    public static string ADP_InvalidDataReaderUnableToDetermineType { get { return default(string); } }
    public static string ADP_InvalidMultipartNameDelimiterUsage { get { return default(string); } }
    public static string ADP_KeysRequiredForNesting { get { return default(string); } }
    public static string ADP_MustUseSequentialAccess { get { return default(string); } }
    public static string ADP_NoData { get { return default(string); } }
    public static string ADP_ProviderDoesNotSupportCommandTrees { get { return default(string); } }
    public static string AllElementsMustBeInSchema { get { return default(string); } }
    public static string AmbiguousFunctionArguments { get { return default(string); } }
    public static string ArgumentMustBeCSpaceType { get { return default(string); } }
    public static string ArgumentMustBeOSpaceType { get { return default(string); } }
    public static string ArrayTooSmall { get { return default(string); } }
    public static string AtleastOneSSDLNeeded { get { return default(string); } }
    public static string BadNavigationPropertyRolesCannotBeTheSame { get { return default(string); } }
    public static string BetweenLimitsCannotBeUntypedNulls { get { return default(string); } }
    public static string CalculatedEnumValueOutOfRange { get { return default(string); } }
    public static string CannotCreateEmptyMultiset { get { return default(string); } }
    public static string CannotCreateMultisetofNulls { get { return default(string); } }
    public static string CannotLoadDifferentVersionOfSchemaInTheSameItemCollection { get { return default(string); } }
    public static string CodeGen_PropertyDeclaringTypeIsValueType { get { return default(string); } }
    public static string CodeGen_PropertyIsIndexed { get { return default(string); } }
    public static string CodeGen_PropertyIsStatic { get { return default(string); } }
    public static string CodeGen_PropertyNoGetter { get { return default(string); } }
    public static string CodeGen_PropertyNoSetter { get { return default(string); } }
    public static string CodeGen_PropertyStrongNameIdentity { get { return default(string); } }
    public static string CodeGen_PropertyUnsupportedForm { get { return default(string); } }
    public static string CodeGen_PropertyUnsupportedType { get { return default(string); } }
    public static string Collections_InvalidEntityStateSource { get { return default(string); } }
    public static string Collections_UnableToMergeCollections { get { return default(string); } }
    public static string CommandTextFunctionsCannotDeclareStoreFunctionName { get { return default(string); } }
    public static string CommandTextFunctionsNotComposable { get { return default(string); } }
    public static string ComplexObject_ComplexObjectAlreadyAttachedToParent { get { return default(string); } }
    public static string ComposableFunctionOrFunctionImportMustDeclareReturnType { get { return default(string); } }
    public static string ConcatBuiltinNotSupported { get { return default(string); } }
    public static string Cqt_Aggregate_InvalidFunction { get { return default(string); } }
    public static string Cqt_And_BooleanArgumentsRequired { get { return default(string); } }
    public static string Cqt_Apply_DuplicateVariableNames { get { return default(string); } }
    public static string Cqt_Arithmetic_NumericCommonType { get { return default(string); } }
    public static string Cqt_Binding_CollectionRequired { get { return default(string); } }
    public static string Cqt_Binding_VariableNameNotValid { get { return default(string); } }
    public static string Cqt_Case_InvalidResultType { get { return default(string); } }
    public static string Cqt_Case_WhensMustEqualThens { get { return default(string); } }
    public static string Cqt_CommandTree_InvalidDataSpace { get { return default(string); } }
    public static string Cqt_Comparison_ComparableRequired { get { return default(string); } }
    public static string Cqt_Constant_InvalidType { get { return default(string); } }
    public static string Cqt_CrossJoin_AtLeastTwoInputs { get { return default(string); } }
    public static string Cqt_DeRef_RefRequired { get { return default(string); } }
    public static string Cqt_Distinct_InvalidCollection { get { return default(string); } }
    public static string Cqt_Element_InvalidArgumentForUnwrapSingleProperty { get { return default(string); } }
    public static string Cqt_Exceptions_InvalidCommandTree { get { return default(string); } }
    public static string Cqt_ExpressionList_IncorrectElementCount { get { return default(string); } }
    public static string Cqt_Factory_IncompatibleRelationEnds { get { return default(string); } }
    public static string Cqt_Factory_NewCollectionInvalidCommonType { get { return default(string); } }
    public static string Cqt_Factory_NoSuchRelationEnd { get { return default(string); } }
    public static string Cqt_Function_CommandTextInExpression { get { return default(string); } }
    public static string Cqt_Function_NonComposableInExpression { get { return default(string); } }
    public static string Cqt_Function_VoidResultInvalid { get { return default(string); } }
    public static string Cqt_General_MetadataNotReadOnly { get { return default(string); } }
    public static string Cqt_General_NoProviderBooleanType { get { return default(string); } }
    public static string Cqt_General_NoProviderIntegerType { get { return default(string); } }
    public static string Cqt_General_NoProviderStringType { get { return default(string); } }
    public static string Cqt_GetEntityRef_EntityRequired { get { return default(string); } }
    public static string Cqt_GetRefKey_RefRequired { get { return default(string); } }
    public static string Cqt_GroupBinding_CollectionRequired { get { return default(string); } }
    public static string Cqt_GroupBinding_GroupVariableNameNotValid { get { return default(string); } }
    public static string Cqt_GroupBy_AtLeastOneKeyOrAggregate { get { return default(string); } }
    public static string Cqt_GroupBy_MoreThanOneGroupAggregate { get { return default(string); } }
    public static string Cqt_IsNull_CollectionNotAllowed { get { return default(string); } }
    public static string Cqt_IsNull_InvalidType { get { return default(string); } }
    public static string Cqt_Join_DuplicateVariableNames { get { return default(string); } }
    public static string Cqt_Limit_ConstantOrParameterRefRequired { get { return default(string); } }
    public static string Cqt_Limit_IntegerRequired { get { return default(string); } }
    public static string Cqt_Limit_NonNegativeLimitRequired { get { return default(string); } }
    public static string Cqt_Metadata_EdmMemberIncorrectSpace { get { return default(string); } }
    public static string Cqt_Metadata_EntitySetEntityContainerNull { get { return default(string); } }
    public static string Cqt_Metadata_EntitySetIncorrectSpace { get { return default(string); } }
    public static string Cqt_Metadata_EntityTypeEmptyKeyMembersInvalid { get { return default(string); } }
    public static string Cqt_Metadata_EntityTypeNullKeyMembersInvalid { get { return default(string); } }
    public static string Cqt_Metadata_FunctionIncorrectSpace { get { return default(string); } }
    public static string Cqt_Metadata_FunctionParameterIncorrectSpace { get { return default(string); } }
    public static string Cqt_Metadata_FunctionReturnParameterNull { get { return default(string); } }
    public static string Cqt_Metadata_TypeUsageIncorrectSpace { get { return default(string); } }
    public static string Cqt_NewInstance_CollectionTypeRequired { get { return default(string); } }
    public static string Cqt_NewInstance_IncompatibleRelatedEntity_SourceTypeNotValid { get { return default(string); } }
    public static string Cqt_NewInstance_StructuralTypeRequired { get { return default(string); } }
    public static string Cqt_Not_BooleanArgumentRequired { get { return default(string); } }
    public static string Cqt_Or_BooleanArgumentsRequired { get { return default(string); } }
    public static string Cqt_Property_InstanceRequiredForInstance { get { return default(string); } }
    public static string Cqt_Ref_PolymorphicArgRequired { get { return default(string); } }
    public static string Cqt_RelatedEntityRef_TargetEndFromDifferentRelationship { get { return default(string); } }
    public static string Cqt_RelatedEntityRef_TargetEndMustBeAtMostOne { get { return default(string); } }
    public static string Cqt_RelatedEntityRef_TargetEndSameAsSourceEnd { get { return default(string); } }
    public static string Cqt_RelatedEntityRef_TargetEntityNotCompatible { get { return default(string); } }
    public static string Cqt_RelatedEntityRef_TargetEntityNotRef { get { return default(string); } }
    public static string Cqt_RelNav_NoCompositions { get { return default(string); } }
    public static string Cqt_Skip_ConstantOrParameterRefRequired { get { return default(string); } }
    public static string Cqt_Skip_IntegerRequired { get { return default(string); } }
    public static string Cqt_Skip_NonNegativeCountRequired { get { return default(string); } }
    public static string Cqt_Sort_EmptyCollationInvalid { get { return default(string); } }
    public static string Cqt_Sort_NonStringCollationInvalid { get { return default(string); } }
    public static string Cqt_Sort_OrderComparable { get { return default(string); } }
    public static string Cqt_Util_CheckListEmptyInvalid { get { return default(string); } }
    public static string CtxAlias { get { return default(string); } }
    public static string CtxAliasedNamespaceImport { get { return default(string); } }
    public static string CtxAnd { get { return default(string); } }
    public static string CtxAnyElement { get { return default(string); } }
    public static string CtxApplyClause { get { return default(string); } }
    public static string CtxBetween { get { return default(string); } }
    public static string CtxCase { get { return default(string); } }
    public static string CtxCaseElse { get { return default(string); } }
    public static string CtxCaseWhenThen { get { return default(string); } }
    public static string CtxCast { get { return default(string); } }
    public static string CtxCollatedOrderByClauseItem { get { return default(string); } }
    public static string CtxCollectionTypeDefinition { get { return default(string); } }
    public static string CtxCommandExpression { get { return default(string); } }
    public static string CtxCreateRef { get { return default(string); } }
    public static string CtxDeref { get { return default(string); } }
    public static string CtxDivide { get { return default(string); } }
    public static string CtxElement { get { return default(string); } }
    public static string CtxEquals { get { return default(string); } }
    public static string CtxEscapedIdentifier { get { return default(string); } }
    public static string CtxExcept { get { return default(string); } }
    public static string CtxExists { get { return default(string); } }
    public static string CtxExpressionList { get { return default(string); } }
    public static string CtxFlatten { get { return default(string); } }
    public static string CtxFromApplyClause { get { return default(string); } }
    public static string CtxFromClause { get { return default(string); } }
    public static string CtxFromClauseItem { get { return default(string); } }
    public static string CtxFromClauseList { get { return default(string); } }
    public static string CtxFromJoinClause { get { return default(string); } }
    public static string CtxFunctionDefinition { get { return default(string); } }
    public static string CtxGreaterThan { get { return default(string); } }
    public static string CtxGreaterThanEqual { get { return default(string); } }
    public static string CtxGroupByClause { get { return default(string); } }
    public static string CtxGroupPartition { get { return default(string); } }
    public static string CtxHavingClause { get { return default(string); } }
    public static string CtxIdentifier { get { return default(string); } }
    public static string CtxIn { get { return default(string); } }
    public static string CtxIntersect { get { return default(string); } }
    public static string CtxIsNotNull { get { return default(string); } }
    public static string CtxIsNotOf { get { return default(string); } }
    public static string CtxIsNull { get { return default(string); } }
    public static string CtxIsOf { get { return default(string); } }
    public static string CtxJoinClause { get { return default(string); } }
    public static string CtxJoinOnClause { get { return default(string); } }
    public static string CtxKey { get { return default(string); } }
    public static string CtxLessThan { get { return default(string); } }
    public static string CtxLessThanEqual { get { return default(string); } }
    public static string CtxLike { get { return default(string); } }
    public static string CtxLimitSubClause { get { return default(string); } }
    public static string CtxLiteral { get { return default(string); } }
    public static string CtxMemberAccess { get { return default(string); } }
    public static string CtxMethod { get { return default(string); } }
    public static string CtxMinus { get { return default(string); } }
    public static string CtxModulus { get { return default(string); } }
    public static string CtxMultiply { get { return default(string); } }
    public static string CtxMultisetCtor { get { return default(string); } }
    public static string CtxNamespaceImport { get { return default(string); } }
    public static string CtxNamespaceImportList { get { return default(string); } }
    public static string CtxNavigate { get { return default(string); } }
    public static string CtxNot { get { return default(string); } }
    public static string CtxNotBetween { get { return default(string); } }
    public static string CtxNotEqual { get { return default(string); } }
    public static string CtxNotIn { get { return default(string); } }
    public static string CtxNotLike { get { return default(string); } }
    public static string CtxNullLiteral { get { return default(string); } }
    public static string CtxOfType { get { return default(string); } }
    public static string CtxOfTypeOnly { get { return default(string); } }
    public static string CtxOr { get { return default(string); } }
    public static string CtxOrderByClause { get { return default(string); } }
    public static string CtxOrderByClauseItem { get { return default(string); } }
    public static string CtxOverlaps { get { return default(string); } }
    public static string CtxParen { get { return default(string); } }
    public static string CtxPlus { get { return default(string); } }
    public static string CtxQueryExpression { get { return default(string); } }
    public static string CtxQueryStatement { get { return default(string); } }
    public static string CtxRef { get { return default(string); } }
    public static string CtxRefTypeDefinition { get { return default(string); } }
    public static string CtxRelationship { get { return default(string); } }
    public static string CtxRelationshipList { get { return default(string); } }
    public static string CtxRowCtor { get { return default(string); } }
    public static string CtxRowTypeDefinition { get { return default(string); } }
    public static string CtxSelectRowClause { get { return default(string); } }
    public static string CtxSelectValueClause { get { return default(string); } }
    public static string CtxSet { get { return default(string); } }
    public static string CtxSimpleIdentifier { get { return default(string); } }
    public static string CtxSkipSubClause { get { return default(string); } }
    public static string CtxTopSubClause { get { return default(string); } }
    public static string CtxTreat { get { return default(string); } }
    public static string CtxTypeName { get { return default(string); } }
    public static string CtxTypeNameWithTypeSpec { get { return default(string); } }
    public static string CtxUnaryMinus { get { return default(string); } }
    public static string CtxUnaryPlus { get { return default(string); } }
    public static string CtxUnion { get { return default(string); } }
    public static string CtxUnionAll { get { return default(string); } }
    public static string CtxWhereClause { get { return default(string); } }
    public static string DefaultNotAllowed { get { return default(string); } }
    public static string DuplicateEnumMember { get { return default(string); } }
    public static string EdmMembersDefiningTypeDoNotAgreeWithMetadataType { get { return default(string); } }
    public static string ElementOperatorIsNotSupported { get { return default(string); } }
    public static string ELinq_AnonymousType { get { return default(string); } }
    public static string ELinq_ClosureType { get { return default(string); } }
    public static string ELinq_CreateOrderedEnumerableNotSupported { get { return default(string); } }
    public static string ELinq_CycleDetected { get { return default(string); } }
    public static string ELinq_EdmFunctionDirectCall { get { return default(string); } }
    public static string ELinq_ExpressionMustBeIQueryable { get { return default(string); } }
    public static string ELinq_MethodNotDirectlyCallable { get { return default(string); } }
    public static string ELinq_PropertyIndexNotSupported { get { return default(string); } }
    public static string ELinq_SkipWithoutOrder { get { return default(string); } }
    public static string ELinq_ThenByDoesNotFollowOrderBy { get { return default(string); } }
    public static string ELinq_UnsupportedBinding { get { return default(string); } }
    public static string ELinq_UnsupportedCastToDecimal { get { return default(string); } }
    public static string ELinq_UnsupportedConstructor { get { return default(string); } }
    public static string ELinq_UnsupportedDifferentContexts { get { return default(string); } }
    public static string ELinq_UnsupportedInclude { get { return default(string); } }
    public static string ELinq_UnsupportedInitializers { get { return default(string); } }
    public static string ELinq_UnsupportedMergeAs { get { return default(string); } }
    public static string ELinq_UnsupportedNestedFirst { get { return default(string); } }
    public static string ELinq_UnsupportedNestedSingle { get { return default(string); } }
    public static string ELinq_UnsupportedQueryableMethod { get { return default(string); } }
    public static string EmptyCommandText { get { return default(string); } }
    public static string EmptyDefiningQuery { get { return default(string); } }
    public static string EmptySchemaTextReader { get { return default(string); } }
    public static string Entity_EntityCantHaveMultipleChangeTrackers { get { return default(string); } }
    public static string EntityClient_CannotCloneStoreProvider { get { return default(string); } }
    public static string EntityClient_CannotDeduceDbType { get { return default(string); } }
    public static string EntityClient_CannotGetCommandText { get { return default(string); } }
    public static string EntityClient_CannotGetCommandTree { get { return default(string); } }
    public static string EntityClient_CannotReopenConnection { get { return default(string); } }
    public static string EntityClient_CannotReprepareCommandDefinitionBasedCommand { get { return default(string); } }
    public static string EntityClient_CannotSetCommandText { get { return default(string); } }
    public static string EntityClient_CannotSetCommandTree { get { return default(string); } }
    public static string EntityClient_ClosedConnectionForUpdate { get { return default(string); } }
    public static string EntityClient_CommandDefinitionExecutionFailed { get { return default(string); } }
    public static string EntityClient_CommandDefinitionPreparationFailed { get { return default(string); } }
    public static string EntityClient_CommandExecutionFailed { get { return default(string); } }
    public static string EntityClient_CommandTreeMetadataIncompatible { get { return default(string); } }
    public static string EntityClient_ConnectionMustBeClosed { get { return default(string); } }
    public static string EntityClient_ConnectionNotOpen { get { return default(string); } }
    public static string EntityClient_ConnectionStateBroken { get { return default(string); } }
    public static string EntityClient_ConnectionStateClosed { get { return default(string); } }
    public static string EntityClient_ConnectionStringNeededBeforeOperation { get { return default(string); } }
    public static string EntityClient_DataReaderIsStillOpen { get { return default(string); } }
    public static string EntityClient_EmptyParameterName { get { return default(string); } }
    public static string EntityClient_ErrorInBeginningTransaction { get { return default(string); } }
    public static string EntityClient_ErrorInClosingConnection { get { return default(string); } }
    public static string EntityClient_ExtraParametersWithNamedConnection { get { return default(string); } }
    public static string EntityClient_FunctionImportEmptyCommandText { get { return default(string); } }
    public static string EntityClient_InvalidNamedConnection { get { return default(string); } }
    public static string EntityClient_InvalidStoredProcedureCommandText { get { return default(string); } }
    public static string EntityClient_InvalidStoreProvider { get { return default(string); } }
    public static string EntityClient_InvalidTransactionForCommand { get { return default(string); } }
    public static string EntityClient_NoCommandText { get { return default(string); } }
    public static string EntityClient_NoConnectionForAdapter { get { return default(string); } }
    public static string EntityClient_NoConnectionForCommand { get { return default(string); } }
    public static string EntityClient_NoStoreConnectionForUpdate { get { return default(string); } }
    public static string EntityClient_ProviderGeneralError { get { return default(string); } }
    public static string EntityClient_RequiresNonStoreCommandTree { get { return default(string); } }
    public static string EntityClient_SettingsCannotBeChangedOnOpenConnection { get { return default(string); } }
    public static string EntityClient_StoreReaderFailed { get { return default(string); } }
    public static string EntityClient_TooFewColumns { get { return default(string); } }
    public static string EntityClient_TransactionAlreadyStarted { get { return default(string); } }
    public static string EntityClient_UnsupportedCommandType { get { return default(string); } }
    public static string EntityClient_ValueNotString { get { return default(string); } }
    public static string EntityKey_CannotChangeKey { get { return default(string); } }
    public static string EntityKey_DataRecordMustBeEntity { get { return default(string); } }
    public static string EntityKey_EntityKeyMustHaveValues { get { return default(string); } }
    public static string EntityKey_InvalidQualifiedEntitySetName { get { return default(string); } }
    public static string EntityKey_MissingEntitySetName { get { return default(string); } }
    public static string EntityKey_NoNullsAllowedInKeyValuePairs { get { return default(string); } }
    public static string EntityKey_UnexpectedNull { get { return default(string); } }
    public static string EntityParameterCollectionRemoveInvalidObject { get { return default(string); } }
    public static string EntityParameterContainedByAnotherCollection { get { return default(string); } }
    public static string EntityParameterNull { get { return default(string); } }
    public static string EntityProxyTypeInfo_ProxyHasWrongWrapper { get { return default(string); } }
    public static string EntityReference_CannotChangeReferentialConstraintProperty { get { return default(string); } }
    public static string EntityReference_CannotSetSpecialKeys { get { return default(string); } }
    public static string EntityReference_EntityKeyValueMismatch { get { return default(string); } }
    public static string EntityReference_LessThanExpectedRelatedEntitiesFound { get { return default(string); } }
    public static string EntityReference_MoreThanExpectedRelatedEntitiesFound { get { return default(string); } }
    public static string EntitySetInAnotherContainer { get { return default(string); } }
    public static string EntityTypesDoNotAgree { get { return default(string); } }
    public static string ExpressionCannotBeNull { get { return default(string); } }
    public static string ExpressionMustBeCollection { get { return default(string); } }
    public static string ExpressionMustBeNumericType { get { return default(string); } }
    public static string ExpressionTypeMustBeBoolean { get { return default(string); } }
    public static string ExpressionTypeMustBeEqualComparable { get { return default(string); } }
    public static string ExpressionTypeMustNotBeCollection { get { return default(string); } }
    public static string ExprIsNotValidEntitySetForCreateRef { get { return default(string); } }
    public static string ExtraInfo { get { return default(string); } }
    public static string FacetDeclarationRequiresTypeAttribute { get { return default(string); } }
    public static string FailedToRetrieveProviderManifest { get { return default(string); } }
    public static string GeneralQueryError { get { return default(string); } }
    public static string Generated_Views_Changed { get { return default(string); } }
    public static string GeneratorErrorSeverityError { get { return default(string); } }
    public static string GeneratorErrorSeverityUnknown { get { return default(string); } }
    public static string GeneratorErrorSeverityWarning { get { return default(string); } }
    public static string GenericSyntaxError { get { return default(string); } }
    public static string GroupingKeysMustBeEqualComparable { get { return default(string); } }
    public static string GroupPartitionOutOfContext { get { return default(string); } }
    public static string GroupVarNotFoundInScope { get { return default(string); } }
    public static string HavingRequiresGroupClause { get { return default(string); } }
    public static string ImcompatibleCreateRefKeyElementType { get { return default(string); } }
    public static string ImcompatibleCreateRefKeyType { get { return default(string); } }
    public static string IncorrectProviderManifest { get { return default(string); } }
    public static string InFromClause { get { return default(string); } }
    public static string InGroupClause { get { return default(string); } }
    public static string InnerJoinMustHaveOnPredicate { get { return default(string); } }
    public static string InRowCtor { get { return default(string); } }
    public static string InSelectProjectionList { get { return default(string); } }
    public static string InvalidArgumentTypeForAggregateFunction { get { return default(string); } }
    public static string InvalidCaseResultTypes { get { return default(string); } }
    public static string InvalidCaseWhenThenNullType { get { return default(string); } }
    public static string InvalidCastExpressionType { get { return default(string); } }
    public static string InvalidCastType { get { return default(string); } }
    public static string InvalidCreateRefKeyType { get { return default(string); } }
    public static string InvalidDistinctArgumentInCtor { get { return default(string); } }
    public static string InvalidDistinctArgumentInNonAggFunction { get { return default(string); } }
    public static string InvalidDocumentationBothTextAndStructure { get { return default(string); } }
    public static string InvalidEmptyIdentifier { get { return default(string); } }
    public static string InvalidEmptyQuery { get { return default(string); } }
    public static string InvalidEmptyQueryTextArgument { get { return default(string); } }
    public static string InvalidEnumUnderlyingType { get { return default(string); } }
    public static string InvalidFlattenArgument { get { return default(string); } }
    public static string InvalidJoinLeftCorrelation { get { return default(string); } }
    public static string InvalidMaxLengthSize { get { return default(string); } }
    public static string InvalidMetadataMemberName { get { return default(string); } }
    public static string InvalidMetadataPath { get { return default(string); } }
    public static string InvalidModeForWithRelationshipClause { get { return default(string); } }
    public static string InvalidNamespaceAlias { get { return default(string); } }
    public static string InvalidNullArithmetic { get { return default(string); } }
    public static string InvalidNullComparison { get { return default(string); } }
    public static string InvalidOperationMultipleEndsInAssociation { get { return default(string); } }
    public static string InvalidOperatorSymbol { get { return default(string); } }
    public static string InvalidPredicateForCrossJoin { get { return default(string); } }
    public static string InvalidPunctuatorSymbol { get { return default(string); } }
    public static string InvalidSavePoint { get { return default(string); } }
    public static string InvalidScopeIndex { get { return default(string); } }
    public static string InvalidSelectValueAliasedExpression { get { return default(string); } }
    public static string InvalidSelectValueList { get { return default(string); } }
    public static string InvalidTypeForWithRelationshipClause { get { return default(string); } }
    public static string Iqt_CTGen_UnexpectedAggregate { get { return default(string); } }
    public static string Iqt_CTGen_UnexpectedVarDef { get { return default(string); } }
    public static string Iqt_CTGen_UnexpectedVarDefList { get { return default(string); } }
    public static string IsNullInvalidType { get { return default(string); } }
    public static string LeftSetExpressionArgsMustBeCollection { get { return default(string); } }
    public static string LikeArgMustBeStringType { get { return default(string); } }
    public static string LocalizedCollection { get { return default(string); } }
    public static string LocalizedColumn { get { return default(string); } }
    public static string LocalizedComplex { get { return default(string); } }
    public static string LocalizedEntity { get { return default(string); } }
    public static string LocalizedEntityContainerExpression { get { return default(string); } }
    public static string LocalizedEnumMember { get { return default(string); } }
    public static string LocalizedFunction { get { return default(string); } }
    public static string LocalizedInlineFunction { get { return default(string); } }
    public static string LocalizedKeyword { get { return default(string); } }
    public static string LocalizedLeft { get { return default(string); } }
    public static string LocalizedLine { get { return default(string); } }
    public static string LocalizedMetadataMemberExpression { get { return default(string); } }
    public static string LocalizedNamespace { get { return default(string); } }
    public static string LocalizedNear { get { return default(string); } }
    public static string LocalizedPrimitive { get { return default(string); } }
    public static string LocalizedReference { get { return default(string); } }
    public static string LocalizedRight { get { return default(string); } }
    public static string LocalizedRow { get { return default(string); } }
    public static string LocalizedTerm { get { return default(string); } }
    public static string LocalizedType { get { return default(string); } }
    public static string LocalizedValueExpression { get { return default(string); } }
    public static string MalformedSingleQuotePayload { get { return default(string); } }
    public static string MalformedStringLiteralPayload { get { return default(string); } }
    public static string Mapping_ConditionValueTypeMismatch { get { return default(string); } }
    public static string Mapping_DifferentEdmStoreVersion { get { return default(string); } }
    public static string Mapping_DifferentMappingEdmStoreVersion { get { return default(string); } }
    public static string Mapping_DistinctFlagInReadWriteContainer { get { return default(string); } }
    public static string Mapping_General_Error { get { return default(string); } }
    public static string Mapping_InvalidContent_Association_Type_Empty { get { return default(string); } }
    public static string Mapping_InvalidContent_ConditionMapping_Both_Members { get { return default(string); } }
    public static string Mapping_InvalidContent_ConditionMapping_Both_Values { get { return default(string); } }
    public static string Mapping_InvalidContent_ConditionMapping_Either_Members { get { return default(string); } }
    public static string Mapping_InvalidContent_ConditionMapping_Either_Values { get { return default(string); } }
    public static string Mapping_InvalidContent_ConditionMapping_NonScalar { get { return default(string); } }
    public static string Mapping_InvalidContent_Container_SubElement { get { return default(string); } }
    public static string Mapping_InvalidContent_General { get { return default(string); } }
    public static string Mapping_InvalidContent_IsTypeOfNotTerminated { get { return default(string); } }
    public static string Mapping_InvalidContent_Table_Expected { get { return default(string); } }
    public static string Mapping_InvalidContent_TypeMapping_QueryView { get { return default(string); } }
    public static string Mapping_ModificationFunction_In_Table_Context { get { return default(string); } }
    public static string Mapping_ModificationFunction_MissingVersion { get { return default(string); } }
    public static string Mapping_ModificationFunction_Multiple_Types { get { return default(string); } }
    public static string Mapping_ModificationFunction_VersionMustBeCurrent { get { return default(string); } }
    public static string Mapping_ModificationFunction_VersionMustBeOriginal { get { return default(string); } }
    public static string Mapping_TypeName_For_First_QueryView { get { return default(string); } }
    public static string Materializer_CannotReEnumerateQueryResults { get { return default(string); } }
    public static string Materializer_PropertyIsNotNullable { get { return default(string); } }
    public static string Materializer_UnsupportedType { get { return default(string); } }
    public static string Metadata_General_Error { get { return default(string); } }
    public static string MethodInvocationNotSupported { get { return default(string); } }
    public static string MismatchNumberOfPropertiesinRelationshipConstraint { get { return default(string); } }
    public static string MissingName { get { return default(string); } }
    public static string MissingNamespaceAttribute { get { return default(string); } }
    public static string MultisetElemsAreNotTypeCompatible { get { return default(string); } }
    public static string NonComposableFunctionHasDisallowedAttribute { get { return default(string); } }
    public static string NonComposableFunctionMustNotDeclareReturnType { get { return default(string); } }
    public static string NotBinaryTypeForTypeUsage { get { return default(string); } }
    public static string NotDateTimeOffsetTypeForTypeUsage { get { return default(string); } }
    public static string NotDateTimeTypeForTypeUsage { get { return default(string); } }
    public static string NotDecimalTypeForTypeUsage { get { return default(string); } }
    public static string NotStringTypeForTypeUsage { get { return default(string); } }
    public static string NotTimeTypeForTypeUsage { get { return default(string); } }
    public static string NotValidInputPath { get { return default(string); } }
    public static string NullLiteralCannotBePromotedToCollectionOfNulls { get { return default(string); } }
    public static string ObjectContext_CannotAttachEntityWithoutKey { get { return default(string); } }
    public static string ObjectContext_CannotAttachEntityWithTemporaryKey { get { return default(string); } }
    public static string ObjectContext_CannotDeleteEntityNotInObjectStateManager { get { return default(string); } }
    public static string ObjectContext_CannotDetachEntityNotInObjectStateManager { get { return default(string); } }
    public static string ObjectContext_CannotSetDefaultContainerName { get { return default(string); } }
    public static string ObjectContext_CommitWithConceptualNull { get { return default(string); } }
    public static string ObjectContext_ContainerQualifiedEntitySetNameRequired { get { return default(string); } }
    public static string ObjectContext_EntityAlreadyExistsInObjectStateManager { get { return default(string); } }
    public static string ObjectContext_EntityNotTrackedOrHasTempKey { get { return default(string); } }
    public static string ObjectContext_EntitySetNameOrEntityKeyRequired { get { return default(string); } }
    public static string ObjectContext_ExecuteCommandWithMixOfDbParameterAndValues { get { return default(string); } }
    public static string ObjectContext_InvalidCommandTimeout { get { return default(string); } }
    public static string ObjectContext_InvalidConnection { get { return default(string); } }
    public static string ObjectContext_InvalidConnectionString { get { return default(string); } }
    public static string ObjectContext_InvalidDataAdapter { get { return default(string); } }
    public static string ObjectContext_InvalidEntityState { get { return default(string); } }
    public static string ObjectContext_InvalidRelationshipState { get { return default(string); } }
    public static string ObjectContext_MetadataHasChanged { get { return default(string); } }
    public static string ObjectContext_ObjectDisposed { get { return default(string); } }
    public static string ObjectContext_ObjectNotFound { get { return default(string); } }
    public static string ObjectContext_QualfiedEntitySetName { get { return default(string); } }
    public static string ObjectContext_RequiredMetadataNotAvailble { get { return default(string); } }
    public static string ObjectContext_SelectorExpressionMustBeMemberAccess { get { return default(string); } }
    public static string ObjectContext_StoreEntityNotPresentInClient { get { return default(string); } }
    public static string ObjectParameterCollection_ParametersLocked { get { return default(string); } }
    public static string ObjectQuery_InvalidConnection { get { return default(string); } }
    public static string ObjectQuery_InvalidEmptyQuery { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidFilterPredicate { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidGroupKeyList { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidProjectionList { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidQueryArgument { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidSkipCount { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidSortKeyList { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_InvalidTopCount { get { return default(string); } }
    public static string ObjectQuery_QueryBuilder_NotSupportedLinqSource { get { return default(string); } }
    public static string ObjectQuery_Span_IncludeRequiresEntityOrEntityCollection { get { return default(string); } }
    public static string ObjectQuery_Span_SpanPathSyntaxError { get { return default(string); } }
    public static string ObjectQuery_Span_WhiteSpacePath { get { return default(string); } }
    public static string ObjectQuery_UnableToMapResultType { get { return default(string); } }
    public static string ObjectStateEntry_CannotAccessKeyEntryValues { get { return default(string); } }
    public static string ObjectStateEntry_CannotDeleteOnKeyEntry { get { return default(string); } }
    public static string ObjectStateEntry_CannotModifyKeyEntryState { get { return default(string); } }
    public static string ObjectStateEntry_CantModifyDetachedDeletedEntries { get { return default(string); } }
    public static string ObjectStateEntry_CantModifyRelationState { get { return default(string); } }
    public static string ObjectStateEntry_CantModifyRelationValues { get { return default(string); } }
    public static string ObjectStateEntry_CantSetEntityKey { get { return default(string); } }
    public static string ObjectStateEntry_CurrentValuesDoesNotExist { get { return default(string); } }
    public static string ObjectStateEntry_EntityMemberChangedWithoutEntityMemberChanging { get { return default(string); } }
    public static string ObjectStateEntry_InvalidState { get { return default(string); } }
    public static string ObjectStateEntry_InvalidTypeForComplexTypeProperty { get { return default(string); } }
    public static string ObjectStateEntry_OriginalValuesDoesNotExist { get { return default(string); } }
    public static string ObjectStateEntry_RelationshipAndKeyEntriesDoNotHaveRelationshipManagers { get { return default(string); } }
    public static string ObjectStateManager_AcceptChangesEntityKeyIsNotValid { get { return default(string); } }
    public static string ObjectStateManager_CannotChangeRelationshipStateEntityAdded { get { return default(string); } }
    public static string ObjectStateManager_CannotChangeRelationshipStateEntityDeleted { get { return default(string); } }
    public static string ObjectStateManager_CannotChangeRelationshipStateKeyEntry { get { return default(string); } }
    public static string ObjectStateManager_CannotFixUpKeyToExistingValues { get { return default(string); } }
    public static string ObjectStateManager_CannotGetRelationshipManagerForDetachedPocoEntity { get { return default(string); } }
    public static string ObjectStateManager_ChangeRelationshipStateNotSupportedForForeignKeyAssociations { get { return default(string); } }
    public static string ObjectStateManager_ChangeStateFromAddedWithNullKeyIsInvalid { get { return default(string); } }
    public static string ObjectStateManager_DetachedObjectStateEntriesDoesNotExistInObjectStateManager { get { return default(string); } }
    public static string ObjectStateManager_EntityConflictsWithKeyEntry { get { return default(string); } }
    public static string ObjectStateManager_EntityNotTracked { get { return default(string); } }
    public static string ObjectStateManager_InvalidKey { get { return default(string); } }
    public static string ObjectStateManager_KeyPropertyDoesntMatchValueInKey { get { return default(string); } }
    public static string ObjectStateManager_KeyPropertyDoesntMatchValueInKeyForAttach { get { return default(string); } }
    public static string ObjectStateManager_NoEntryExistForEntityKey { get { return default(string); } }
    public static string ObjectStateManager_ObjectStateManagerContainsThisEntityKey { get { return default(string); } }
    public static string ObjectView_AddNewOperationNotAllowedOnAbstractBindingList { get { return default(string); } }
    public static string ObjectView_CannotReplacetheEntityorRow { get { return default(string); } }
    public static string ObjectView_IncompatibleArgument { get { return default(string); } }
    public static string ObjectView_IndexBasedInsertIsNotSupported { get { return default(string); } }
    public static string ObjectView_WriteOperationNotAllowedOnReadOnlyBindingList { get { return default(string); } }
    public static string OnlyStoreConnectionsSupported { get { return default(string); } }
    public static string OperationOnReadOnlyCollection { get { return default(string); } }
    public static string OperationOnReadOnlyItem { get { return default(string); } }
    public static string OrderByKeyIsNotOrderComparable { get { return default(string); } }
    public static string PlusLeftExpressionInvalidType { get { return default(string); } }
    public static string PlusRightExpressionInvalidType { get { return default(string); } }
    public static string ProviderDidNotCreateACommandDefinition { get { return default(string); } }
    public static string ProviderDidNotReturnAProviderManifest { get { return default(string); } }
    public static string ProviderDidNotReturnAProviderManifestToken { get { return default(string); } }
    public static string ProviderDidNotReturnSpatialServices { get { return default(string); } }
    public static string ProviderDoesNotSupportCreateDatabase { get { return default(string); } }
    public static string ProviderDoesNotSupportCreateDatabaseScript { get { return default(string); } }
    public static string ProviderDoesNotSupportDatabaseExists { get { return default(string); } }
    public static string ProviderDoesNotSupportDeleteDatabase { get { return default(string); } }
    public static string ProviderEscapeLikeArgumentReturnedNull { get { return default(string); } }
    public static string ProviderManifestTokenNotFound { get { return default(string); } }
    public static string ProviderRequiresStoreCommandTree { get { return default(string); } }
    public static string ProviderReturnedNullForCreateCommandDefinition { get { return default(string); } }
    public static string ProviderShouldOverrideEscapeLikeArgument { get { return default(string); } }
    public static string RelatedEnd_CannotCreateRelationshipEntitiesInDifferentContexts { get { return default(string); } }
    public static string RelatedEnd_ConflictingChangeOfRelationshipDetected { get { return default(string); } }
    public static string RelatedEnd_InvalidEntityContextForAttach { get { return default(string); } }
    public static string RelatedEnd_InvalidEntityStateForAttach { get { return default(string); } }
    public static string RelatedEnd_InvalidOwnerStateForAttach { get { return default(string); } }
    public static string RelatedEnd_LoadCalledOnAlreadyLoadedNoTrackedRelatedEnd { get { return default(string); } }
    public static string RelatedEnd_LoadCalledOnNonEmptyNoTrackedRelatedEnd { get { return default(string); } }
    public static string RelatedEnd_OwnerIsNull { get { return default(string); } }
    public static string RelatedEnd_RelatedEndNotFound { get { return default(string); } }
    public static string RelatedEnd_UnableToAddEntity { get { return default(string); } }
    public static string RelatedEnd_UnableToAddRelationshipWithDeletedEntity { get { return default(string); } }
    public static string RelatedEnd_UnableToRemoveEntity { get { return default(string); } }
    public static string RelatedEndExprTypeMustBeReference { get { return default(string); } }
    public static string RelationshipFromEndIsAmbiguos { get { return default(string); } }
    public static string RelationshipManager_CannotGetRelatEndForDetachedPocoEntity { get { return default(string); } }
    public static string RelationshipManager_CircularRelationshipsWithReferentialConstraints { get { return default(string); } }
    public static string RelationshipManager_CollectionInitializeIsForDeserialization { get { return default(string); } }
    public static string RelationshipManager_InconsistentReferentialConstraintProperties { get { return default(string); } }
    public static string RelationshipManager_InitializeIsForDeserialization { get { return default(string); } }
    public static string RelationshipManager_InvalidRelationshipManagerOwner { get { return default(string); } }
    public static string RelationshipManager_UnableToRetrieveReferentialConstraintProperties { get { return default(string); } }
    public static string RelationshipManager_UnexpectedNull { get { return default(string); } }
    public static string RelationshipManager_UnexpectedNullContext { get { return default(string); } }
    public static string RelationshipToEndIsAmbiguos { get { return default(string); } }
    public static string ResultingExpressionTypeCannotBeNull { get { return default(string); } }
    public static string RightSetExpressionArgsMustBeCollection { get { return default(string); } }
    public static string RowCtorElementCannotBeNull { get { return default(string); } }
    public static string RowTypeWithoutProperty { get { return default(string); } }
    public static string SelectDistinctMustBeEqualComparable { get { return default(string); } }
    public static string SourceUriUnknown { get { return default(string); } }
    public static string Spatial_GeographyValueNotCompatibleWithSpatialServices { get { return default(string); } }
    public static string Spatial_GeometryValueNotCompatibleWithSpatialServices { get { return default(string); } }
    public static string Spatial_ProviderValueNotCompatibleWithSpatialServices { get { return default(string); } }
    public static string Spatial_WellKnownGeographyValueNotValid { get { return default(string); } }
    public static string Spatial_WellKnownGeometryValueNotValid { get { return default(string); } }
    public static string Spatial_WellKnownValueSerializationPropertyNotDirectlySettable { get { return default(string); } }
    public static string SpatialWithUseStrongSpatialTypesFalse { get { return default(string); } }
    public static string SqlGen_ApplyNotSupportedOnSql8 { get { return default(string); } }
    public static string SqlGen_NiladicFunctionsCannotHaveParameters { get { return default(string); } }
    public static string SqlGen_ParameterForLimitNotSupportedOnSql8 { get { return default(string); } }
    public static string SqlGen_ParameterForSkipNotSupportedOnSql8 { get { return default(string); } }
    public static string SqlProvider_CredentialsMissingForMasterConnection { get { return default(string); } }
    public static string SqlProvider_DdlGeneration_CannotDeleteDatabaseNoInitialCatalog { get { return default(string); } }
    public static string SqlProvider_DdlGeneration_CannotTellIfDatabaseExists { get { return default(string); } }
    public static string SqlProvider_DdlGeneration_MissingInitialCatalog { get { return default(string); } }
    public static string SqlProvider_GeographyValueNotSqlCompatible { get { return default(string); } }
    public static string SqlProvider_GeometryValueNotSqlCompatible { get { return default(string); } }
    public static string SqlProvider_IncompleteCreateDatabase { get { return default(string); } }
    public static string SqlProvider_IncompleteCreateDatabaseAggregate { get { return default(string); } }
    public static string SqlProvider_Sql2008RequiredForSpatial { get { return default(string); } }
    public static string SqlProvider_SqlTypesAssemblyNotFound { get { return default(string); } }
    public static string SqlSpatialservices_CouldNotCreateWellKnownGeographyValueNoSrid { get { return default(string); } }
    public static string SqlSpatialservices_CouldNotCreateWellKnownGeographyValueNoWkbOrWkt { get { return default(string); } }
    public static string SqlSpatialservices_CouldNotCreateWellKnownGeometryValueNoSrid { get { return default(string); } }
    public static string SqlSpatialservices_CouldNotCreateWellKnownGeometryValueNoWkbOrWkt { get { return default(string); } }
    public static string StackOverflowInParser { get { return default(string); } }
    public static string TopAndLimitCannotCoexist { get { return default(string); } }
    public static string TopAndSkipCannotCoexist { get { return default(string); } }
    public static string TVFReturnTypeRowHasNonScalarProperty { get { return default(string); } }
    public static string TypeArgumentIsNotValid { get { return default(string); } }
    public static string TypeArgumentMustBeLiteral { get { return default(string); } }
    public static string TypeDeclaredAsAttributeAndElement { get { return default(string); } }
    public static string TypeMustBeDeclared { get { return default(string); } }
    public static string TypeMustBeInheritableType { get { return default(string); } }
    public static string UnableToDetermineApplicationContext { get { return default(string); } }
    public static string UnableToDetermineStoreVersion { get { return default(string); } }
    public static string UnableToLoadResource { get { return default(string); } }
    public static string UnknownAstCommandExpression { get { return default(string); } }
    public static string UnknownAstExpressionType { get { return default(string); } }
    public static string UnknownBuiltInAstExpressionType { get { return default(string); } }
    public static string Update_AmbiguousServerGenIdentifier { get { return default(string); } }
    public static string Update_CircularRelationships { get { return default(string); } }
    public static string Update_ConstraintCycle { get { return default(string); } }
    public static string Update_DuplicateKeys { get { return default(string); } }
    public static string Update_ErrorLoadingRecord { get { return default(string); } }
    public static string Update_GeneralExecutionException { get { return default(string); } }
    public static string Update_InvalidChanges { get { return default(string); } }
    public static string Update_ReferentialConstraintIntegrityViolation { get { return default(string); } }
    public static string Update_WorkspaceMismatch { get { return default(string); } }
    public static string Validator_BaseTypeHasMemberOfSameName { get { return default(string); } }
    public static string Validator_CollectionHasNoTypeUsage { get { return default(string); } }
    public static string Validator_CollectionTypesCannotHaveBaseType { get { return default(string); } }
    public static string Validator_EmptyIdentity { get { return default(string); } }
    public static string Validator_FacetHasNoName { get { return default(string); } }
    public static string Validator_FacetTypeIsNull { get { return default(string); } }
    public static string Validator_ItemAttributeHasNullTypeUsage { get { return default(string); } }
    public static string Validator_MemberHasNoName { get { return default(string); } }
    public static string Validator_MemberHasNullDeclaringType { get { return default(string); } }
    public static string Validator_MemberHasNullTypeUsage { get { return default(string); } }
    public static string Validator_MetadataPropertyHasNoName { get { return default(string); } }
    public static string Validator_OSpace_Convention_NonMatchingUnderlyingTypes { get { return default(string); } }
    public static string Validator_RefTypeHasNullEntityType { get { return default(string); } }
    public static string Validator_RefTypesCannotHaveBaseType { get { return default(string); } }
    public static string Validator_TypeHasNoName { get { return default(string); } }
    public static string Validator_TypeHasNoNamespace { get { return default(string); } }
    public static string Validator_TypeUsageHasNullEdmType { get { return default(string); } }
    public static string ViewGen_AND { get { return default(string); } }
    public static string ViewGen_CommaBlank { get { return default(string); } }
    public static string ViewGen_Entities { get { return default(string); } }
    public static string ViewGen_EntityInstanceToken { get { return default(string); } }
    public static string ViewGen_Error { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Disj_Eq { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Disj_Subs { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Disj_Subs_Ref { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Disj_Unk { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Eq_Disj { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Eq_Subs { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Eq_Subs_Ref { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Eq_Unk { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Eq_Unk_Association { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Sub_Disj { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Sub_Eq { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Sub_Eq_Ref { get { return default(string); } }
    public static string Viewgen_ErrorPattern_Partition_Sub_Unk { get { return default(string); } }
    public static string ViewGen_Extent { get { return default(string); } }
    public static string Viewgen_NoJoinKeyOrFK { get { return default(string); } }
    public static string ViewGen_NotNull { get { return default(string); } }
    public static string ViewGen_Null { get { return default(string); } }
    public static string ViewGen_Tuples { get { return default(string); } }
    public static string WildcardEnumeratorReturnedNull { get { return default(string); } }
    public static string ADP_CollectionParameterElementIsNull(object p0) { return default(string); }
    public static string ADP_CollectionParameterElementIsNullOrEmpty(object p0) { return default(string); }
    public static string ADP_ConnectionStringSyntax(object p0) { return default(string); }
    public static string ADP_DataReaderClosed(object p0) { return default(string); }
    public static string ADP_InternalProviderError(object p0) { return default(string); }
    public static string ADP_InvalidBufferSizeOrIndex(object p0, object p1) { return default(string); }
    public static string ADP_InvalidConnectionOptionValue(object p0) { return default(string); }
    public static string ADP_InvalidDataLength(object p0) { return default(string); }
    public static string ADP_InvalidDataReaderMissingColumnForType(object p0, object p1) { return default(string); }
    public static string ADP_InvalidDataReaderMissingDiscriminatorColumn(object p0, object p1) { return default(string); }
    public static string ADP_InvalidDataReaderUnableToMaterializeNonScalarType(object p0, object p1) { return default(string); }
    public static string ADP_InvalidDataType(object p0) { return default(string); }
    public static string ADP_InvalidDestinationBufferIndex(object p0, object p1) { return default(string); }
    public static string ADP_InvalidEnumerationValue(object p0, object p1) { return default(string); }
    public static string ADP_InvalidSizeValue(object p0) { return default(string); }
    public static string ADP_InvalidSourceBufferIndex(object p0, object p1) { return default(string); }
    public static string ADP_KeysRequiredForJoinOverNest(object p0) { return default(string); }
    public static string ADP_KeywordNotSupported(object p0) { return default(string); }
    public static string ADP_NestingNotSupported(object p0, object p1) { return default(string); }
    public static string ADP_NonSequentialChunkAccess(object p0, object p1, object p2) { return default(string); }
    public static string ADP_NonSequentialColumnAccess(object p0, object p1) { return default(string); }
    public static string ADP_NoQueryMappingView(object p0, object p1) { return default(string); }
    public static string ADP_UnknownDataTypeCode(object p0, object p1) { return default(string); }
    public static string AliasNameAlreadyUsed(object p0) { return default(string); }
    public static string AliasNameIsAlreadyDefined(object p0) { return default(string); }
    public static string AllArtifactsMustTargetSameProvider_InvariantName(object p0, object p1) { return default(string); }
    public static string AllArtifactsMustTargetSameProvider_ManifestToken(object p0, object p1) { return default(string); }
    public static string AmbiguousEntityContainerEnd(object p0, object p1) { return default(string); }
    public static string AmbiguousFunctionAndType(object p0, object p1) { return default(string); }
    public static string AmbiguousFunctionOverload(object p0, object p1) { return default(string); }
    public static string AmbiguousMetadataMemberName(object p0, object p1, object p2) { return default(string); }
    public static string ArgumentOutOfRange(object p0) { return default(string); }
    public static string ArgumentOutOfRangeExpectedPostiveNumber(object p0) { return default(string); }
    public static string ArgumentTypesAreIncompatible(object p0, object p1) { return default(string); }
    public static string AssemblyMissingFromAssembliesToConsider(object p0) { return default(string); }
    public static string BadNamespaceOrAlias(object p0) { return default(string); }
    public static string BadNavigationPropertyBadFromRoleType(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string BadNavigationPropertyRelationshipNotRelationship(object p0) { return default(string); }
    public static string BadNavigationPropertyUndefinedRole(object p0, object p1) { return default(string); }
    public static string BadParameterDirection(object p0, object p1, object p2, object p3) { return default(string); }
    public static string BadParameterDirectionForComposableFunctions(object p0, object p1, object p2, object p3) { return default(string); }
    public static string BadPrecisionAndScale(object p0, object p1) { return default(string); }
    public static string BetweenLimitsTypesAreNotCompatible(object p0, object p1) { return default(string); }
    public static string BetweenLimitsTypesAreNotOrderComparable(object p0, object p1) { return default(string); }
    public static string BetweenValueIsNotOrderComparable(object p0, object p1) { return default(string); }
    public static string BothMinAndMaxValueMustBeSpecifiedForNonConstantFacet(object p0, object p1) { return default(string); }
    public static string CannotCallNoncomposableFunction(object p0) { return default(string); }
    public static string CannotConvertNumericLiteral(object p0, object p1) { return default(string); }
    public static string CannotInstantiateAbstractType(object p0) { return default(string); }
    public static string CannotResolveNameToTypeOrFunction(object p0) { return default(string); }
    public static string CannotUseSystemNamespaceAsAlias(object p0) { return default(string); }
    public static string CheckArgumentContainsNullFailed(object p0) { return default(string); }
    public static string CodeGen_ConstructorNoParameterless(object p0) { return default(string); }
    public static string Collections_CannotFillTryDifferentMergeOption(object p0, object p1) { return default(string); }
    public static string Collections_ExpectedCollectionGotReference(object p0, object p1, object p2) { return default(string); }
    public static string Collections_InvalidEntityStateLoad(object p0) { return default(string); }
    public static string Collections_NoRelationshipSetMatched(object p0) { return default(string); }
    public static string CompiledELinq_UnsupportedNamedParameterType(object p0, object p1) { return default(string); }
    public static string CompiledELinq_UnsupportedNamedParameterUseAsType(object p0, object p1) { return default(string); }
    public static string CompiledELinq_UnsupportedParameterTypes(object p0) { return default(string); }
    public static string ComplexObject_ComplexChangeRequestedOnScalarProperty(object p0) { return default(string); }
    public static string ComplexObject_NullableComplexTypesNotSupported(object p0) { return default(string); }
    public static string ComplexTypeAsReturnTypeAndDefinedEntitySet(object p0, object p1) { return default(string); }
    public static string ComplexTypeAsReturnTypeAndNestedComplexProperty(object p0, object p1, object p2) { return default(string); }
    public static string ConcurrencyRedefinedOnSubTypeOfEntitySetType(object p0, object p1, object p2) { return default(string); }
    public static string ConstantFacetSpecifiedInSchema(object p0, object p1) { return default(string); }
    public static string CouldNotResolveIdentifier(object p0) { return default(string); }
    public static string Cqt_Arithmetic_InvalidUnsignedTypeForUnaryMinus(object p0) { return default(string); }
    public static string Cqt_Binary_CollectionsRequired(object p0) { return default(string); }
    public static string Cqt_Cast_InvalidCast(object p0, object p1) { return default(string); }
    public static string Cqt_CommandTree_InvalidParameterName(object p0) { return default(string); }
    public static string Cqt_Constant_ClrEnumTypeDoesNotMatchEdmEnumType(object p0, object p1, object p2) { return default(string); }
    public static string Cqt_Constant_InvalidConstantType(object p0) { return default(string); }
    public static string Cqt_Constant_InvalidValueForType(object p0) { return default(string); }
    public static string Cqt_Copier_EndNotFound(object p0, object p1) { return default(string); }
    public static string Cqt_Copier_EntityContainerNotFound(object p0) { return default(string); }
    public static string Cqt_Copier_EntitySetNotFound(object p0, object p1) { return default(string); }
    public static string Cqt_Copier_FunctionNotFound(object p0) { return default(string); }
    public static string Cqt_Copier_NavPropertyNotFound(object p0, object p1) { return default(string); }
    public static string Cqt_Copier_PropertyNotFound(object p0, object p1) { return default(string); }
    public static string Cqt_Copier_TypeNotFound(object p0) { return default(string); }
    public static string Cqt_CrossJoin_DuplicateVariableNames(object p0, object p1, object p2) { return default(string); }
    public static string Cqt_ExpressionLink_TypeMismatch(object p0, object p1) { return default(string); }
    public static string Cqt_Factory_MethodResultTypeNotSupported(object p0) { return default(string); }
    public static string Cqt_Factory_NoSuchProperty(object p0, object p1) { return default(string); }
    public static string Cqt_Function_CanonicalFunction_AmbiguousMatch(object p0) { return default(string); }
    public static string Cqt_Function_CanonicalFunction_NotFound(object p0) { return default(string); }
    public static string Cqt_General_PolymorphicArgRequired(object p0) { return default(string); }
    public static string Cqt_General_PolymorphicTypeRequired(object p0) { return default(string); }
    public static string Cqt_General_UnsupportedExpression(object p0) { return default(string); }
    public static string Cqt_GroupBy_AggregateColumnExistsAsGroupColumn(object p0) { return default(string); }
    public static string Cqt_GroupBy_KeyNotEqualityComparable(object p0) { return default(string); }
    public static string Cqt_InvalidTypeForSetOperation(object p0, object p1) { return default(string); }
    public static string Cqt_NewInstance_CannotInstantiateAbstractType(object p0) { return default(string); }
    public static string Cqt_NewInstance_CannotInstantiateMemberlessType(object p0) { return default(string); }
    public static string Cqt_RelNav_WrongSourceType(object p0) { return default(string); }
    public static string Cqt_UDF_FunctionDefinitionGenerationFailed(object p0) { return default(string); }
    public static string Cqt_UDF_FunctionDefinitionResultTypeMismatch(object p0, object p1, object p2) { return default(string); }
    public static string Cqt_UDF_FunctionDefinitionWithCircularReference(object p0) { return default(string); }
    public static string Cqt_UDF_FunctionHasNoDefinition(object p0) { return default(string); }
    public static string Cqt_Unary_CollectionRequired(object p0) { return default(string); }
    public static string Cqt_Util_CheckListDuplicateName(object p0, object p1, object p2) { return default(string); }
    public static string Cqt_Validator_InvalidIncompatibleParameterReferences(object p0) { return default(string); }
    public static string Cqt_Validator_InvalidIncorrectDataSpaceMetadata(object p0, object p1) { return default(string); }
    public static string Cqt_Validator_InvalidOtherWorkspaceMetadata(object p0) { return default(string); }
    public static string Cqt_Validator_VarRefInvalid(object p0) { return default(string); }
    public static string Cqt_Validator_VarRefTypeMismatch(object p0) { return default(string); }
    public static string CreateRefTypeIdentifierMustBeASubOrSuperType(object p0, object p1) { return default(string); }
    public static string CreateRefTypeIdentifierMustSpecifyAnEntityType(object p0, object p1) { return default(string); }
    public static string CtxFunction(object p0) { return default(string); }
    public static string CtxTypeCtor(object p0) { return default(string); }
    public static string CycleInTypeHierarchy(object p0) { return default(string); }
    public static string DeRefArgIsNotOfRefType(object p0) { return default(string); }
    public static string DifferentSchemaVersionInCollection(object p0, object p1, object p2) { return default(string); }
    public static string DuplicateAnnotation(object p0, object p1) { return default(string); }
    public static string DuplicatedFunctionoverloads(object p0, object p1) { return default(string); }
    public static string DuplicatedInlineFunctionOverload(object p0) { return default(string); }
    public static string DuplicateEndName(object p0) { return default(string); }
    public static string DuplicateEntityContainerMemberName(object p0) { return default(string); }
    public static string DuplicateEntitySetTable(object p0, object p1, object p2) { return default(string); }
    public static string DuplicateMemberName(object p0, object p1, object p2) { return default(string); }
    public static string DuplicateMemberNameInExtendedEntityContainer(object p0, object p1, object p2) { return default(string); }
    public static string DuplicatePropertyNameSpecifiedInEntityKey(object p0, object p1) { return default(string); }
    public static string DuplicationOperation(object p0) { return default(string); }
    public static string EdmVersionNotSupportedByRuntime(object p0, object p1) { return default(string); }
    public static string ELinq_EdmFunctionAttributedFunctionWithWrongReturnType(object p0, object p1) { return default(string); }
    public static string ELinq_EdmFunctionAttributeParameterNameNotValid(object p0, object p1, object p2) { return default(string); }
    public static string ELinq_InvalidOfTypeResult(object p0) { return default(string); }
    public static string ELinq_NotPropertyOrField(object p0) { return default(string); }
    public static string ELinq_UnboundParameterExpression(object p0) { return default(string); }
    public static string ELinq_UnexpectedTypeForNavigationProperty(object p0, object p1, object p2, object p3) { return default(string); }
    public static string ELinq_UnhandledBindingType(object p0) { return default(string); }
    public static string ELinq_UnhandledExpressionType(object p0) { return default(string); }
    public static string ELinq_UnrecognizedMember(object p0) { return default(string); }
    public static string ELinq_UnresolvableFunctionForExpression(object p0) { return default(string); }
    public static string ELinq_UnresolvableFunctionForMember(object p0, object p1) { return default(string); }
    public static string ELinq_UnresolvableFunctionForMethod(object p0, object p1) { return default(string); }
    public static string ELinq_UnresolvableFunctionForMethodAmbiguousMatch(object p0, object p1) { return default(string); }
    public static string ELinq_UnresolvableFunctionForMethodNotFound(object p0, object p1) { return default(string); }
    public static string ELinq_UnresolvableStoreFunctionForExpression(object p0) { return default(string); }
    public static string ELinq_UnresolvableStoreFunctionForMember(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedAsUnicodeAndAsNonUnicode(object p0) { return default(string); }
    public static string ELinq_UnsupportedCast(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedComparison(object p0) { return default(string); }
    public static string ELinq_UnsupportedConstant(object p0) { return default(string); }
    public static string ELinq_UnsupportedEnumerableType(object p0) { return default(string); }
    public static string ELinq_UnsupportedExpressionType(object p0) { return default(string); }
    public static string ELinq_UnsupportedHeterogeneousInitializers(object p0) { return default(string); }
    public static string ELinq_UnsupportedIsOrAs(object p0, object p1, object p2) { return default(string); }
    public static string ELinq_UnsupportedKeySelector(object p0) { return default(string); }
    public static string ELinq_UnsupportedMethod(object p0) { return default(string); }
    public static string ELinq_UnsupportedMethodSuggestedAlternative(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedNominalType(object p0) { return default(string); }
    public static string ELinq_UnsupportedNullConstant(object p0) { return default(string); }
    public static string ELinq_UnsupportedPassthrough(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedRefComparison(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedRowComparison(object p0) { return default(string); }
    public static string ELinq_UnsupportedRowMemberComparison(object p0) { return default(string); }
    public static string ELinq_UnsupportedRowTypeComparison(object p0) { return default(string); }
    public static string ELinq_UnsupportedStringRemoveCase(object p0, object p1) { return default(string); }
    public static string ELinq_UnsupportedTrimStartTrimEndCase(object p0) { return default(string); }
    public static string ELinq_UnsupportedType(object p0) { return default(string); }
    public static string ELinq_UnsupportedUseOfContextParameter(object p0) { return default(string); }
    public static string ELinq_UnsupportedVBDatePartInvalidInterval(object p0, object p1, object p2) { return default(string); }
    public static string ELinq_UnsupportedVBDatePartNonConstantInterval(object p0, object p1) { return default(string); }
    public static string EmptyFile(object p0) { return default(string); }
    public static string EmptyName(object p0) { return default(string); }
    public static string EndNameAlreadyDefinedDuplicate(object p0) { return default(string); }
    public static string EndWithManyMultiplicityCannotHaveOperationsSpecified(object p0, object p1) { return default(string); }
    public static string EndWithoutMultiplicity(object p0, object p1) { return default(string); }
    public static string EntityClient_ConnectionStringMissingInfo(object p0) { return default(string); }
    public static string EntityClient_DbConnectionHasNoProvider(object p0) { return default(string); }
    public static string EntityClient_DoesNotImplementIServiceProvider(object p0) { return default(string); }
    public static string EntityClient_DuplicateParameterNames(object p0) { return default(string); }
    public static string EntityClient_EntityParameterEdmTypeNotScalar(object p0) { return default(string); }
    public static string EntityClient_EntityParameterInconsistentEdmType(object p0, object p1) { return default(string); }
    public static string EntityClient_ExecutingOnClosedConnection(object p0) { return default(string); }
    public static string EntityClient_FailedToGetInformation(object p0) { return default(string); }
    public static string EntityClient_FunctionImportMustBeNonComposable(object p0) { return default(string); }
    public static string EntityClient_IncompatibleNavigationPropertyResult(object p0, object p1) { return default(string); }
    public static string EntityClient_InvalidParameterDirection(object p0) { return default(string); }
    public static string EntityClient_InvalidParameterName(object p0) { return default(string); }
    public static string EntityClient_ItemCollectionsNotRegisteredInWorkspace(object p0) { return default(string); }
    public static string EntityClient_KeywordNotSupported(object p0) { return default(string); }
    public static string EntityClient_NestedNamedConnection(object p0) { return default(string); }
    public static string EntityClient_ProviderSpecificError(object p0) { return default(string); }
    public static string EntityClient_ReturnedNullOnProviderMethod(object p0, object p1) { return default(string); }
    public static string EntityClient_UnableToFindFunctionImport(object p0, object p1) { return default(string); }
    public static string EntityClient_UnableToFindFunctionImportContainer(object p0) { return default(string); }
    public static string EntityClient_UnknownParameterType(object p0) { return default(string); }
    public static string EntityClient_UnmappedFunctionImport(object p0) { return default(string); }
    public static string EntityClient_UnsupportedDbType(object p0, object p1) { return default(string); }
    public static string EntityContainerAlreadyExists(object p0) { return default(string); }
    public static string EntityContainerCannotExtendItself(object p0) { return default(string); }
    public static string EntityKey_DoesntMatchKeyOnEntity(object p0) { return default(string); }
    public static string EntityKey_EntitySetDoesNotMatch(object p0) { return default(string); }
    public static string EntityKey_EntityTypesDoNotMatch(object p0, object p1) { return default(string); }
    public static string EntityKey_IncorrectNumberOfKeyValuePairs(object p0, object p1, object p2) { return default(string); }
    public static string EntityKey_IncorrectValueType(object p0, object p1, object p2) { return default(string); }
    public static string EntityKey_InvalidName(object p0) { return default(string); }
    public static string EntityKey_MissingKeyValue(object p0, object p1) { return default(string); }
    public static string EntityKey_NoCorrespondingOSpaceTypeForEnumKeyMember(object p0, object p1) { return default(string); }
    public static string EntityKey_NullKeyValue(object p0, object p1) { return default(string); }
    public static string EntityKeyMustBeScalar(object p0, object p1) { return default(string); }
    public static string EntityKeyTypeCurrentlyNotSupported(object p0, object p1, object p2) { return default(string); }
    public static string EntityKeyTypeCurrentlyNotSupportedInSSDL(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string EntityParameterCollectionInvalidIndex(object p0, object p1) { return default(string); }
    public static string EntityParameterCollectionInvalidParameterName(object p0) { return default(string); }
    public static string EntityProxyTypeInfo_CannotSetEntityCollectionProperty(object p0, object p1) { return default(string); }
    public static string EntityProxyTypeInfo_DuplicateOSpaceType(object p0) { return default(string); }
    public static string EntityProxyTypeInfo_ProxyMetadataIsUnavailable(object p0) { return default(string); }
    public static string EntityReference_CannotAddMoreThanOneEntityToEntityReference(object p0, object p1) { return default(string); }
    public static string EntityReference_ExpectedReferenceGotCollection(object p0, object p1, object p2) { return default(string); }
    public static string EntitySetNotInCSPace(object p0) { return default(string); }
    public static string EntitySetTypeHasNoKeys(object p0, object p1) { return default(string); }
    public static string EnumMemberValueOutOfItsUnderylingTypeRange(object p0, object p1, object p2) { return default(string); }
    public static string ExpressionTypeMustBeEntityType(object p0, object p1, object p2) { return default(string); }
    public static string ExpressionTypeMustBeNominalType(object p0, object p1, object p2) { return default(string); }
    public static string FacetNotAllowed(object p0, object p1) { return default(string); }
    public static string FacetsOnNonScalarType(object p0) { return default(string); }
    public static string FailedToFindClrTypeMapping(object p0) { return default(string); }
    public static string FailedToFindCSpaceTypeMapping(object p0) { return default(string); }
    public static string FailedToFindOSpaceTypeMapping(object p0) { return default(string); }
    public static string FailedToResolveAggregateFunction(object p0) { return default(string); }
    public static string FunctionImportCollectionAndRefParametersNotAllowed(object p0) { return default(string); }
    public static string FunctionImportComposableAndSideEffectingNotAllowed(object p0) { return default(string); }
    public static string FunctionImportEntitySetAndEntitySetPathDeclared(object p0) { return default(string); }
    public static string FunctionImportEntityTypeDoesNotMatchEntitySet(object p0, object p1, object p2) { return default(string); }
    public static string FunctionImportNonNullableParametersNotAllowed(object p0) { return default(string); }
    public static string FunctionImportReturnEntitiesButDoesNotSpecifyEntitySet(object p0) { return default(string); }
    public static string FunctionImportSpecifiesEntitySetButNotEntityType(object p0) { return default(string); }
    public static string FunctionImportUnknownEntitySet(object p0, object p1) { return default(string); }
    public static string FunctionImportWithUnsupportedReturnTypeV1(object p0) { return default(string); }
    public static string FunctionImportWithUnsupportedReturnTypeV1_1(object p0) { return default(string); }
    public static string FunctionImportWithUnsupportedReturnTypeV2(object p0) { return default(string); }
    public static string FunctionWithNonEdmPrimitiveTypeNotSupported(object p0, object p1) { return default(string); }
    public static string FunctionWithNonPrimitiveTypeNotSupported(object p0, object p1) { return default(string); }
    public static string GeneralExceptionAsQueryInnerException(object p0) { return default(string); }
    public static string Generated_View_Type_Super_Class(object p0) { return default(string); }
    public static string Generated_Views_Invalid_Extent(object p0) { return default(string); }
    public static string GenericTypeNotSupported(object p0) { return default(string); }
    public static string InferRelationshipEndAmbiguous(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string InferRelationshipEndFailedNoEntitySetMatch(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string InferRelationshipEndGivesAlreadyDefinedEnd(object p0, object p1) { return default(string); }
    public static string InvalidAction(object p0, object p1) { return default(string); }
    public static string InvalidAliasName(object p0) { return default(string); }
    public static string InvalidAssociationTypeForUnion(object p0) { return default(string); }
    public static string InvalidBaseTypeForItemType(object p0, object p1) { return default(string); }
    public static string InvalidBaseTypeForNestedType(object p0, object p1) { return default(string); }
    public static string InvalidBaseTypeForStructuredType(object p0, object p1) { return default(string); }
    public static string InvalidCast(object p0, object p1) { return default(string); }
    public static string InvalidCollectionForMapping(object p0) { return default(string); }
    public static string InvalidCollectionSpecified(object p0) { return default(string); }
    public static string InvalidComplexType(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidCtorArgumentType(object p0, object p1, object p2) { return default(string); }
    public static string InvalidCtorUseOnType(object p0) { return default(string); }
    public static string InvalidDateTimeOffsetLiteral(object p0) { return default(string); }
    public static string InvalidDay(object p0, object p1) { return default(string); }
    public static string InvalidDayInMonth(object p0, object p1, object p2) { return default(string); }
    public static string InvalidDefaultBinaryWithNoMaxLength(object p0) { return default(string); }
    public static string InvalidDefaultBoolean(object p0) { return default(string); }
    public static string InvalidDefaultDateTime(object p0, object p1) { return default(string); }
    public static string InvalidDefaultDateTimeOffset(object p0, object p1) { return default(string); }
    public static string InvalidDefaultDecimal(object p0, object p1, object p2) { return default(string); }
    public static string InvalidDefaultFloatingPoint(object p0, object p1, object p2) { return default(string); }
    public static string InvalidDefaultGuid(object p0) { return default(string); }
    public static string InvalidDefaultIntegral(object p0, object p1, object p2) { return default(string); }
    public static string InvalidDefaultTime(object p0, object p1) { return default(string); }
    public static string InvalidDeRefProperty(object p0, object p1, object p2) { return default(string); }
    public static string InvalidEDMVersion(object p0) { return default(string); }
    public static string InvalidEndEntitySetTypeMismatch(object p0) { return default(string); }
    public static string InvalidEndRoleInRelationshipConstraint(object p0, object p1) { return default(string); }
    public static string InvalidEntityContainerNameInExtends(object p0) { return default(string); }
    public static string InvalidEntityEndName(object p0, object p1) { return default(string); }
    public static string InvalidEntityParameterType(object p0) { return default(string); }
    public static string InvalidEntityRootTypeArgument(object p0, object p1) { return default(string); }
    public static string InvalidEntitySetName(object p0) { return default(string); }
    public static string InvalidEntitySetNameReference(object p0, object p1) { return default(string); }
    public static string InvalidEntitySetType(object p0) { return default(string); }
    public static string InvalidEntityTypeArgument(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidEscapedIdentifier(object p0) { return default(string); }
    public static string InvalidEscapedIdentifierUnbalanced(object p0) { return default(string); }
    public static string InvalidExpressionResolutionClass(object p0, object p1) { return default(string); }
    public static string InvalidFileExtension(object p0, object p1, object p2) { return default(string); }
    public static string InvalidFromPropertyInRelationshipConstraint(object p0, object p1, object p2) { return default(string); }
    public static string InvalidGroupIdentifierReference(object p0) { return default(string); }
    public static string InvalidHour(object p0, object p1) { return default(string); }
    public static string InvalidImplicitRelationshipFromEnd(object p0) { return default(string); }
    public static string InvalidImplicitRelationshipToEnd(object p0) { return default(string); }
    public static string InvalidInExprArgs(object p0, object p1) { return default(string); }
    public static string InvalidKeyArgument(object p0) { return default(string); }
    public static string InvalidKeyKeyDefinedInBaseClass(object p0, object p1) { return default(string); }
    public static string InvalidKeyMember(object p0) { return default(string); }
    public static string InvalidKeyNoProperty(object p0, object p1) { return default(string); }
    public static string InvalidKeyNullablePart(object p0, object p1) { return default(string); }
    public static string InvalidKeyTypeForCollation(object p0) { return default(string); }
    public static string InvalidLiteralFormat(object p0, object p1) { return default(string); }
    public static string InvalidMemberNameMatchesTypeName(object p0, object p1) { return default(string); }
    public static string InvalidMetadataMemberClassResolution(object p0, object p1, object p2) { return default(string); }
    public static string InvalidMinute(object p0, object p1) { return default(string); }
    public static string InvalidMonth(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityFromRoleToPropertyNonNullableV1(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityFromRoleToPropertyNonNullableV2(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityFromRoleToPropertyNullableV1(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityFromRoleUpperBoundMustBeOne(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityToRoleLowerBoundMustBeZero(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityToRoleUpperBoundMustBeMany(object p0, object p1) { return default(string); }
    public static string InvalidMultiplicityToRoleUpperBoundMustBeOne(object p0, object p1) { return default(string); }
    public static string InvalidName(object p0, object p1) { return default(string); }
    public static string InvalidNamespaceInUsing(object p0) { return default(string); }
    public static string InvalidNamespaceOrAliasSpecified(object p0) { return default(string); }
    public static string InvalidNullLiteralForNonNullableMember(object p0, object p1) { return default(string); }
    public static string InvalidNumberOfParametersForAggregateFunction(object p0) { return default(string); }
    public static string InvalidParameterFormat(object p0) { return default(string); }
    public static string InvalidParameterTypeForAggregateFunction(object p0, object p1) { return default(string); }
    public static string InvalidPlaceholderRootTypeArgument(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidPlaceholderTypeArgument(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string InvalidPrimitiveTypeKind(object p0) { return default(string); }
    public static string InvalidPropertyInRelationshipConstraint(object p0, object p1) { return default(string); }
    public static string InvalidPropertyType(object p0) { return default(string); }
    public static string InvalidQueryResultType(object p0) { return default(string); }
    public static string InvalidRelationshipEndMultiplicity(object p0, object p1) { return default(string); }
    public static string InvalidRelationshipEndType(object p0, object p1) { return default(string); }
    public static string InvalidRelationshipMember(object p0, object p1) { return default(string); }
    public static string InvalidRelationshipSetName(object p0) { return default(string); }
    public static string InvalidRelationshipSetType(object p0) { return default(string); }
    public static string InvalidRootComplexType(object p0, object p1) { return default(string); }
    public static string InvalidRootRowType(object p0, object p1) { return default(string); }
    public static string InvalidRowType(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidSchemaEncountered(object p0) { return default(string); }
    public static string InvalidSecond(object p0, object p1) { return default(string); }
    public static string InvalidSimpleIdentifier(object p0) { return default(string); }
    public static string InvalidSimpleIdentifierNonASCII(object p0) { return default(string); }
    public static string InvalidSize(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidStringArgument(object p0) { return default(string); }
    public static string InvalidSystemReferenceId(object p0, object p1, object p2, object p3) { return default(string); }
    public static string InvalidToPropertyInRelationshipConstraint(object p0, object p1, object p2) { return default(string); }
    public static string InvalidUnarySetOpArgument(object p0) { return default(string); }
    public static string InvalidUnsignedTypeForUnaryMinusOperation(object p0) { return default(string); }
    public static string InvalidUseOfWebPath(object p0) { return default(string); }
    public static string InvalidValueForParameterTypeSemanticsAttribute(object p0) { return default(string); }
    public static string InvalidWithRelationshipTargetEndMultiplicity(object p0, object p1) { return default(string); }
    public static string InvalidYear(object p0, object p1) { return default(string); }
    public static string Iqt_General_UnsupportedOp(object p0) { return default(string); }
    public static string ItemCollectionAlreadyRegistered(object p0) { return default(string); }
    public static string ItemDuplicateIdentity(object p0) { return default(string); }
    public static string ItemInvalidIdentity(object p0) { return default(string); }
    public static string KeyMissingOnEntityType(object p0) { return default(string); }
    public static string KeyMustBeCorrelated(object p0) { return default(string); }
    public static string LiteralTypeNotFoundInMetadata(object p0) { return default(string); }
    public static string LiteralTypeNotSupported(object p0) { return default(string); }
    public static string MalformedXml(object p0, object p1) { return default(string); }
    public static string Mapping_AbstractTypeMappingToNonAbstractType(object p0, object p1) { return default(string); }
    public static string Mapping_AllQueryViewAtCompileTime(object p0) { return default(string); }
    public static string Mapping_AlreadyMapped_StorageEntityContainer(object p0) { return default(string); }
    public static string Mapping_CannotMapCLRTypeMultipleTimes(object p0) { return default(string); }
    public static string Mapping_Default_OCMapping_Clr_Member(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_Default_OCMapping_Clr_Member2(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_Default_OCMapping_Invalid_MemberType(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Mapping_Default_OCMapping_Member_Count_Mismatch(object p0, object p1) { return default(string); }
    public static string Mapping_Default_OCMapping_MemberKind_Mismatch(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Mapping_Default_OCMapping_MultiplicityMismatch(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Mapping_Duplicate_CdmAssociationSet_StorageMap(object p0) { return default(string); }
    public static string Mapping_Duplicate_PropertyMap_CaseInsensitive(object p0) { return default(string); }
    public static string Mapping_Duplicate_Type(object p0) { return default(string); }
    public static string Mapping_Empty_QueryView(object p0) { return default(string); }
    public static string Mapping_Empty_QueryView_OfType(object p0, object p1) { return default(string); }
    public static string Mapping_Empty_QueryView_OfTypeOnly(object p0, object p1) { return default(string); }
    public static string Mapping_EntitySetMismatchOnAssociationSetEnd_QueryView(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_Enum_EmptyValue(object p0) { return default(string); }
    public static string Mapping_Enum_InvalidValue(object p0) { return default(string); }
    public static string Mapping_Enum_OCMapping_MemberMismatch(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_Enum_OCMapping_UnderlyingTypesMismatch(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_EnumTypeMappingToNonEnumType(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_CannotInferTargetFunctionKeys(object p0) { return default(string); }
    public static string Mapping_FunctionImport_ConditionValueTypeMismatch(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_FunctionImport_EntityTypeMappingForFunctionNotReturningEntitySet(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_FunctionAmbiguous(object p0) { return default(string); }
    public static string Mapping_FunctionImport_FunctionImportDoesNotExist(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_FunctionImportMappedMultipleTimes(object p0) { return default(string); }
    public static string Mapping_FunctionImport_ImplicitMappingForAbstractReturnType(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_ImportParameterHasNoCorrespondingTargetParameter(object p0) { return default(string); }
    public static string Mapping_FunctionImport_IncompatibleEnumParameterType(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_FunctionImport_IncompatibleParameterMode(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_FunctionImport_IncompatibleParameterType(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_FunctionImport_InvalidContentEntityTypeForEntitySet(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_FunctionImport_PropertyNotMapped(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_FunctionImport_ResultMapping_InvalidCTypeCTExpected(object p0) { return default(string); }
    public static string Mapping_FunctionImport_ResultMapping_InvalidCTypeETExpected(object p0) { return default(string); }
    public static string Mapping_FunctionImport_ResultMapping_InvalidSType(object p0) { return default(string); }
    public static string Mapping_FunctionImport_ResultMapping_MappedTypeDoesNotMatchReturnType(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_ResultMappingCountDoesNotMatchResultCount(object p0) { return default(string); }
    public static string Mapping_FunctionImport_RowsAffectedParameterDoesNotExist(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_RowsAffectedParameterHasWrongMode(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_FunctionImport_RowsAffectedParameterHasWrongType(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_ScalarMappingToMulticolumnTVF(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_ScalarMappingTypeMismatch(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_FunctionImport_StoreFunctionDoesNotExist(object p0) { return default(string); }
    public static string Mapping_FunctionImport_TargetFunctionMustBeComposable(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_TargetFunctionMustBeNonComposable(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_TargetParameterHasNoCorrespondingImportParameter(object p0) { return default(string); }
    public static string Mapping_FunctionImport_UnreachableIsTypeOf(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_UnreachableType(object p0, object p1) { return default(string); }
    public static string Mapping_FunctionImport_UnsupportedType(object p0, object p1) { return default(string); }
    public static string Mapping_Invalid_Association_Type_For_Association_Set(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_Invalid_CSide_ScalarProperty(object p0) { return default(string); }
    public static string Mapping_Invalid_CSRootElementMissing(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_Invalid_Member_Mapping(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Mapping_Invalid_Query_Views_MissingSetClosure(object p0) { return default(string); }
    public static string Mapping_Invalid_QueryView(object p0, object p1) { return default(string); }
    public static string Mapping_Invalid_QueryView_Type(object p0) { return default(string); }
    public static string Mapping_Invalid_QueryView2(object p0, object p1) { return default(string); }
    public static string Mapping_InvalidContent_AbstractEntity_FunctionMapping(object p0) { return default(string); }
    public static string Mapping_InvalidContent_AbstractEntity_IsOfType(object p0) { return default(string); }
    public static string Mapping_InvalidContent_AbstractEntity_Type(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Association_Set(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Association_Type(object p0) { return default(string); }
    public static string Mapping_InvalidContent_AssociationSet_Condition(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Cdm_Member(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Column(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Complex_Type(object p0) { return default(string); }
    public static string Mapping_InvalidContent_ConditionMapping_Computed(object p0) { return default(string); }
    public static string Mapping_InvalidContent_ConditionMapping_InvalidMember(object p0) { return default(string); }
    public static string Mapping_InvalidContent_ConditionMapping_InvalidPrimitiveTypeKind(object p0, object p1) { return default(string); }
    public static string Mapping_InvalidContent_Duplicate_Cdm_Member(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Duplicate_Condition_Member(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Emtpty_SetMap(object p0) { return default(string); }
    public static string Mapping_InvalidContent_End(object p0) { return default(string); }
    public static string Mapping_InvalidContent_EndProperty(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Entity_Set(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Entity_Type(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Entity_Type_For_Entity_Set(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_InvalidContent_EntityContainer(object p0) { return default(string); }
    public static string Mapping_InvalidContent_ForeignKey_Association_Set(object p0) { return default(string); }
    public static string Mapping_InvalidContent_ForeignKey_Association_Set_PKtoPK(object p0) { return default(string); }
    public static string Mapping_InvalidContent_StorageEntityContainer(object p0) { return default(string); }
    public static string Mapping_InvalidContent_Table(object p0) { return default(string); }
    public static string Mapping_InvalidMappingSchema_Parsing(object p0) { return default(string); }
    public static string Mapping_InvalidMappingSchema_validation(object p0) { return default(string); }
    public static string Mapping_ItemWithSameNameExistsBothInCSpaceAndSSpace(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AmbiguousFunction(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AmbiguousResultBinding(object p0, object p1) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationEndMappingForeignKeyAssociation(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationEndMappingInvalidForEntityType(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetAmbiguous(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetCardinality(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetDoesNotExist(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetFromRoleIsNotEntitySet(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetNotMappedForOperation(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Mapping_ModificationFunction_AssociationSetRoleDoesNotExist(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_ComplexTypeNotFound(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_MissingEntityType(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_MissingParameter(object p0, object p1) { return default(string); }
    public static string Mapping_ModificationFunction_MissingSetClosure(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_MultipleEndsOfAssociationMapped(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_ModificationFunction_NotValidFunction(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_NotValidFunctionParameter(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_ModificationFunction_ParameterBoundTwice(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_ParameterNotFound(object p0, object p1) { return default(string); }
    public static string Mapping_ModificationFunction_PropertyNotFound(object p0, object p1) { return default(string); }
    public static string Mapping_ModificationFunction_PropertyNotKey(object p0, object p1) { return default(string); }
    public static string Mapping_ModificationFunction_PropertyParameterTypeMismatch(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Mapping_ModificationFunction_RedundantEntityTypeMapping(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_UnknownFunction(object p0) { return default(string); }
    public static string Mapping_ModificationFunction_WrongComplexType(object p0, object p1) { return default(string); }
    public static string Mapping_NotFound_EntityContainer(object p0) { return default(string); }
    public static string Mapping_Object_InvalidType(object p0) { return default(string); }
    public static string Mapping_Provider_WrongConnectionType(object p0) { return default(string); }
    public static string Mapping_Provider_WrongManifestType(object p0) { return default(string); }
    public static string Mapping_ProviderReturnsNullType(object p0) { return default(string); }
    public static string Mapping_QueryView_Duplicate_OfType(object p0, object p1) { return default(string); }
    public static string Mapping_QueryView_Duplicate_OfTypeOnly(object p0, object p1) { return default(string); }
    public static string Mapping_QueryView_For_Base_Type(object p0, object p1) { return default(string); }
    public static string Mapping_QueryView_PropertyMaps(object p0) { return default(string); }
    public static string Mapping_QueryView_TypeName_Not_Defined(object p0) { return default(string); }
    public static string Mapping_QueryViewMultipleTypeInTypeName(object p0) { return default(string); }
    public static string Mapping_Storage_InvalidSpace(object p0) { return default(string); }
    public static string Mapping_StoreTypeMismatch_ScalarPropertyMapping(object p0, object p1) { return default(string); }
    public static string Mapping_TableName_QueryView(object p0) { return default(string); }
    public static string Mapping_UnsupportedExpressionKind_QueryView(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_UnsupportedFunctionCall_QueryView(object p0, object p1) { return default(string); }
    public static string Mapping_UnsupportedInitialization_QueryView(object p0, object p1) { return default(string); }
    public static string Mapping_UnsupportedPropertyKind_QueryView(object p0, object p1, object p2) { return default(string); }
    public static string Mapping_UnsupportedScanTarget_QueryView(object p0, object p1) { return default(string); }
    public static string Mapping_Views_For_Extent_Not_Generated(object p0, object p1) { return default(string); }
    public static string Materializer_AddedEntityAlreadyExists(object p0) { return default(string); }
    public static string Materializer_InvalidCastNullable(object p0, object p1) { return default(string); }
    public static string Materializer_InvalidCastReference(object p0, object p1) { return default(string); }
    public static string Materializer_NullReferenceCast(object p0) { return default(string); }
    public static string Materializer_PropertyIsNotNullableWithName(object p0) { return default(string); }
    public static string Materializer_RecyclingEntity(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Materializer_SetInvalidValue(object p0, object p1, object p2, object p3) { return default(string); }
    public static string MemberDoesNotBelongToEntityContainer(object p0, object p1) { return default(string); }
    public static string MemberInvalidIdentity(object p0) { return default(string); }
    public static string MinAndMaxMustBePositive(object p0, object p1) { return default(string); }
    public static string MinAndMaxValueMustBeDifferentForNonConstantFacet(object p0, object p1) { return default(string); }
    public static string MinAndMaxValueMustBeSameForConstantFacet(object p0, object p1) { return default(string); }
    public static string MinMustBeLessThanMax(object p0, object p1, object p2) { return default(string); }
    public static string MissingConstraintOnRelationshipType(object p0) { return default(string); }
    public static string MissingDefaultValueForConstantFacet(object p0, object p1) { return default(string); }
    public static string MissingEntityContainerEnd(object p0, object p1) { return default(string); }
    public static string MissingFacetDescription(object p0, object p1, object p2) { return default(string); }
    public static string MoreThanOneItemMatchesIdentity(object p0) { return default(string); }
    public static string MultipleDefinitionsOfParameter(object p0) { return default(string); }
    public static string MultipleDefinitionsOfVariable(object p0) { return default(string); }
    public static string NamespaceAliasAlreadyUsed(object p0) { return default(string); }
    public static string NamespaceAlreadyImported(object p0) { return default(string); }
    public static string NavigationPropertyRelationshipEndTypeMismatch(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string NeedNotUseSystemNamespaceInUsing(object p0) { return default(string); }
    public static string NestedAggregateCannotBeUsedInAggregate(object p0, object p1) { return default(string); }
    public static string NestedClassNotSupported(object p0, object p1) { return default(string); }
    public static string NewTypeConflictsWithExistingType(object p0, object p1) { return default(string); }
    public static string NoAggrFunctionOverloadMatch(object p0, object p1, object p2) { return default(string); }
    public static string NoCanonicalAggrFunctionOverloadMatch(object p0, object p1, object p2) { return default(string); }
    public static string NoCanonicalFunctionOverloadMatch(object p0, object p1, object p2) { return default(string); }
    public static string NoCodeGenNamespaceInStructuralAnnotation(object p0) { return default(string); }
    public static string NoCollectionForSpace(object p0) { return default(string); }
    public static string NoFunctionOverloadMatch(object p0, object p1, object p2) { return default(string); }
    public static string NoStoreTypeForEdmType(object p0, object p1) { return default(string); }
    public static string NotAMemberOfCollection(object p0, object p1) { return default(string); }
    public static string NotAMemberOfType(object p0, object p1) { return default(string); }
    public static string NotASuperOrSubType(object p0, object p1) { return default(string); }
    public static string NotInNamespaceAlias(object p0, object p1, object p2) { return default(string); }
    public static string NotInNamespaceNoAlias(object p0, object p1) { return default(string); }
    public static string NotNamespaceQualified(object p0) { return default(string); }
    public static string NullParameterForEdmRelationshipAttribute(object p0, object p1) { return default(string); }
    public static string NullRelationshipNameforEdmRelationshipAttribute(object p0) { return default(string); }
    public static string NumberOfTypeCtorIsLessThenFormalSpec(object p0) { return default(string); }
    public static string NumberOfTypeCtorIsMoreThenFormalSpec(object p0) { return default(string); }
    public static string ObjectContext_AcceptAllChangesFailure(object p0) { return default(string); }
    public static string ObjectContext_CannotExplicitlyLoadDetachedRelationships(object p0) { return default(string); }
    public static string ObjectContext_CannotLoadReferencesUsingDifferentContext(object p0) { return default(string); }
    public static string ObjectContext_ClientEntityRemovedFromStore(object p0) { return default(string); }
    public static string ObjectContext_EntitiesHaveDifferentType(object p0, object p1) { return default(string); }
    public static string ObjectContext_EntityContainerNotFoundForName(object p0) { return default(string); }
    public static string ObjectContext_EntityMustBeUnchangedOrModified(object p0) { return default(string); }
    public static string ObjectContext_EntityMustBeUnchangedOrModifiedOrDeleted(object p0) { return default(string); }
    public static string ObjectContext_EntityNotInObjectSet_Delete(object p0, object p1, object p2, object p3) { return default(string); }
    public static string ObjectContext_EntityNotInObjectSet_Detach(object p0, object p1, object p2, object p3) { return default(string); }
    public static string ObjectContext_EntitySetNotFoundForName(object p0) { return default(string); }
    public static string ObjectContext_ExecuteFunctionCalledWithNonQueryFunction(object p0) { return default(string); }
    public static string ObjectContext_ExecuteFunctionCalledWithNullParameter(object p0) { return default(string); }
    public static string ObjectContext_ExecuteFunctionCalledWithScalarFunction(object p0, object p1) { return default(string); }
    public static string ObjectContext_ExecuteFunctionTypeMismatch(object p0, object p1) { return default(string); }
    public static string ObjectContext_InvalidDefaultContainerName(object p0) { return default(string); }
    public static string ObjectContext_InvalidEntitySetForStoreQuery(object p0, object p1, object p2) { return default(string); }
    public static string ObjectContext_InvalidEntitySetInKey(object p0, object p1, object p2, object p3) { return default(string); }
    public static string ObjectContext_InvalidEntitySetInKeyFromName(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string ObjectContext_InvalidEntitySetOnEntity(object p0, object p1) { return default(string); }
    public static string ObjectContext_InvalidObjectSetTypeForEntitySet(object p0, object p1, object p2) { return default(string); }
    public static string ObjectContext_InvalidTypeForStoreQuery(object p0) { return default(string); }
    public static string ObjectContext_MultipleEntitySetsFoundInAllContainers(object p0) { return default(string); }
    public static string ObjectContext_MultipleEntitySetsFoundInSingleContainer(object p0, object p1) { return default(string); }
    public static string ObjectContext_NoEntitySetFoundForType(object p0) { return default(string); }
    public static string ObjectContext_NoMappingForEntityType(object p0) { return default(string); }
    public static string ObjectContext_NthElementInAddedState(object p0) { return default(string); }
    public static string ObjectContext_NthElementIsDuplicate(object p0) { return default(string); }
    public static string ObjectContext_NthElementIsNull(object p0) { return default(string); }
    public static string ObjectContext_NthElementNotInObjectStateManager(object p0) { return default(string); }
    public static string ObjectContext_TwoPropertiesMappedToSameColumn(object p0, object p1) { return default(string); }
    public static string ObjectParameter_InvalidParameterName(object p0) { return default(string); }
    public static string ObjectParameter_InvalidParameterType(object p0) { return default(string); }
    public static string ObjectParameterCollection_DuplicateParameterName(object p0) { return default(string); }
    public static string ObjectParameterCollection_ParameterAlreadyExists(object p0) { return default(string); }
    public static string ObjectParameterCollection_ParameterNameNotFound(object p0) { return default(string); }
    public static string ObjectQuery_InvalidQueryName(object p0) { return default(string); }
    public static string ObjectQuery_QueryBuilder_InvalidResultType(object p0) { return default(string); }
    public static string ObjectQuery_Span_NoNavProp(object p0, object p1) { return default(string); }
    public static string ObjectQuery_UnableToMaterializeArbitaryProjectionType(object p0) { return default(string); }
    public static string ObjectQuery_UnableToMaterializeArray(object p0, object p1) { return default(string); }
    public static string ObjectStateEntry_CannotModifyKeyProperty(object p0) { return default(string); }
    public static string ObjectStateEntry_ChangedInDifferentStateFromChanging(object p0, object p1) { return default(string); }
    public static string ObjectStateEntry_ChangeOnUnmappedComplexProperty(object p0) { return default(string); }
    public static string ObjectStateEntry_ChangeOnUnmappedProperty(object p0) { return default(string); }
    public static string ObjectStateEntry_ComplexObjectUsedMultipleTimes(object p0, object p1) { return default(string); }
    public static string ObjectStateEntry_NullOriginalValueForNonNullableProperty(object p0, object p1, object p2) { return default(string); }
    public static string ObjectStateEntry_SetModifiedOnInvalidProperty(object p0) { return default(string); }
    public static string ObjectStateEntry_SetModifiedStates(object p0) { return default(string); }
    public static string ObjectStateEntry_SetOriginalComplexProperties(object p0) { return default(string); }
    public static string ObjectStateEntry_SetOriginalPrimaryKey(object p0) { return default(string); }
    public static string ObjectStateEntry_UnableToEnumerateCollection(object p0, object p1) { return default(string); }
    public static string ObjectStateManager_ConflictingChangesOfRelationshipDetected(object p0, object p1) { return default(string); }
    public static string ObjectStateManager_DoesnotAllowToReAddUnchangedOrModifiedOrDeletedEntity(object p0) { return default(string); }
    public static string ObjectStateManager_EntityTypeDoesnotMatchtoEntitySetType(object p0, object p1) { return default(string); }
    public static string ObjectStateManager_GetEntityKeyRequiresObjectToHaveAKey(object p0) { return default(string); }
    public static string ObjectStateManager_NoEntryExistsForObject(object p0) { return default(string); }
    public static string ObjectView_CannotResolveTheEntitySet(object p0) { return default(string); }
    public static string OfTypeExpressionElementTypeMustBeEntityType(object p0, object p1) { return default(string); }
    public static string OfTypeExpressionElementTypeMustBeNominalType(object p0, object p1) { return default(string); }
    public static string OfTypeOnlyTypeArgumentCannotBeAbstract(object p0) { return default(string); }
    public static string ParameterNameAlreadyDefinedDuplicate(object p0) { return default(string); }
    public static string ParameterTypeNotSupported(object p0, object p1) { return default(string); }
    public static string ParameterWasNotDefined(object p0) { return default(string); }
    public static string PlaceholderExpressionMustBeCompatibleWithEdm64(object p0, object p1) { return default(string); }
    public static string PlaceholderExpressionMustBeConstant(object p0) { return default(string); }
    public static string PlaceholderExpressionMustBeGreaterThanOrEqualToZero(object p0) { return default(string); }
    public static string PlaceholderSetArgTypeIsNotEqualComparable(object p0, object p1, object p2) { return default(string); }
    public static string PocoEntityWrapper_UnableToMaterializeArbitaryNavPropType(object p0, object p1) { return default(string); }
    public static string PocoEntityWrapper_UnableToSetFieldOrProperty(object p0, object p1) { return default(string); }
    public static string PocoEntityWrapper_UnexpectedTypeForNavigationProperty(object p0, object p1) { return default(string); }
    public static string PrecisionMustBeGreaterThanScale(object p0, object p1) { return default(string); }
    public static string PrecisionOutOfRange(object p0, object p1, object p2, object p3) { return default(string); }
    public static string PropertyNameAlreadyDefinedDuplicate(object p0) { return default(string); }
    public static string PropertyTypeAlreadyDefined(object p0) { return default(string); }
    public static string ProviderDoesNotSupportType(object p0) { return default(string); }
    public static string ProviderReturnedNullForGetDbInformation(object p0) { return default(string); }
    public static string RefArgIsNotOfEntityType(object p0) { return default(string); }
    public static string ReferenceToNonEntityType(object p0) { return default(string); }
    public static string RefTypeIdentifierMustSpecifyAnEntityType(object p0, object p1) { return default(string); }
    public static string RelatedEnd_CannotAddToFixedSizeArray(object p0) { return default(string); }
    public static string RelatedEnd_CannotCreateRelationshipBetweenTrackedAndNoTrackedEntities(object p0) { return default(string); }
    public static string RelatedEnd_CannotRemoveFromFixedSizeArray(object p0) { return default(string); }
    public static string RelatedEnd_CannotSerialize(object p0) { return default(string); }
    public static string RelatedEnd_EntitySetIsNotValidForRelationship(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string RelatedEnd_InvalidContainedType_Collection(object p0, object p1) { return default(string); }
    public static string RelatedEnd_InvalidContainedType_Reference(object p0, object p1) { return default(string); }
    public static string RelatedEnd_InvalidNthElementContextForAttach(object p0) { return default(string); }
    public static string RelatedEnd_InvalidNthElementNullForAttach(object p0) { return default(string); }
    public static string RelatedEnd_InvalidNthElementStateForAttach(object p0) { return default(string); }
    public static string RelatedEnd_InvalidRelationshipFixupDetected(object p0, object p1) { return default(string); }
    public static string RelatedEnd_MismatchedMergeOptionOnLoad(object p0) { return default(string); }
    public static string RelatedEnd_RelatedEndNotAttachedToContext(object p0) { return default(string); }
    public static string RelatedEndExprTypeMustBePromotoableToToEnd(object p0, object p1) { return default(string); }
    public static string RelationshipManager_CollectionAlreadyInitialized(object p0) { return default(string); }
    public static string RelationshipManager_CollectionRelationshipManagerAttached(object p0) { return default(string); }
    public static string RelationshipManager_InvalidTargetRole(object p0, object p1) { return default(string); }
    public static string RelationshipManager_NavigationPropertyNotFound(object p0) { return default(string); }
    public static string RelationshipManager_OwnerIsNotSourceType(object p0, object p1, object p2, object p3) { return default(string); }
    public static string RelationshipManager_ReferenceAlreadyInitialized(object p0) { return default(string); }
    public static string RelationshipManager_RelationshipManagerAttached(object p0) { return default(string); }
    public static string RelationshipManager_UnableToFindRelationshipTypeInMetadata(object p0) { return default(string); }
    public static string RelationshipNameInNavigationPropertyNotValid(object p0, object p1, object p2) { return default(string); }
    public static string RelationshipTargetMustBeUnique(object p0) { return default(string); }
    public static string RelationshipTypeExpected(object p0) { return default(string); }
    public static string RequiredFacetMissing(object p0, object p1) { return default(string); }
    public static string RoleTypeInEdmRelationshipAttributeIsInvalidType(object p0, object p1, object p2) { return default(string); }
    public static string SameRoleNameOnRelationshipAttribute(object p0, object p1) { return default(string); }
    public static string SameRoleReferredInReferentialConstraint(object p0) { return default(string); }
    public static string ScaleOutOfRange(object p0, object p1, object p2, object p3) { return default(string); }
    public static string SimilarRelationshipEnd(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string SourceTypeMustBePromotoableToFromEndRelationType(object p0, object p1) { return default(string); }
    public static string SqlGen_CanonicalFunctionNotSupportedPriorSql10(object p0) { return default(string); }
    public static string SqlGen_InvalidDatePartArgumentExpression(object p0, object p1) { return default(string); }
    public static string SqlGen_InvalidDatePartArgumentValue(object p0, object p1, object p2) { return default(string); }
    public static string SqlGen_PrimitiveTypeNotSupportedPriorSql10(object p0) { return default(string); }
    public static string SqlGen_TypedNaNNotSupported(object p0) { return default(string); }
    public static string SqlGen_TypedNegativeInfinityNotSupported(object p0, object p1) { return default(string); }
    public static string SqlGen_TypedPositiveInfinityNotSupported(object p0, object p1) { return default(string); }
    public static string SqlProvider_InvalidGeographyColumn(object p0) { return default(string); }
    public static string SqlProvider_InvalidGeometryColumn(object p0) { return default(string); }
    public static string SqlProvider_NeedSqlDataReader(object p0) { return default(string); }
    public static string SqlSpatialServices_ProviderValueNotSqlType(object p0) { return default(string); }
    public static string StorageEntityContainerNameMismatchWhileSpecifyingPartialMapping(object p0, object p1, object p2) { return default(string); }
    public static string StoreItemCollectionMustHaveOneArtifact(object p0) { return default(string); }
    public static string SystemNamespaceEncountered(object p0) { return default(string); }
    public static string TableAndSchemaAreMutuallyExclusiveWithDefiningQuery(object p0) { return default(string); }
    public static string TargetRoleNameInNavigationPropertyNotValid(object p0, object p1, object p2, object p3) { return default(string); }
    public static string TextNotAllowed(object p0) { return default(string); }
    public static string TooManyAssociationEnds(object p0) { return default(string); }
    public static string TypeArgumentBelowMin(object p0) { return default(string); }
    public static string TypeArgumentCountMismatch(object p0, object p1) { return default(string); }
    public static string TypeArgumentExceedsMax(object p0) { return default(string); }
    public static string TypeDoesNotSupportFacet(object p0, object p1) { return default(string); }
    public static string TypeDoesNotSupportSpec(object p0) { return default(string); }
    public static string TypeKindMismatch(object p0, object p1, object p2, object p3) { return default(string); }
    public static string TypeMismatchRelationshipConstaint(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string TypeMustBeEntityType(object p0, object p1, object p2) { return default(string); }
    public static string TypeMustBeNominalType(object p0, object p1, object p2) { return default(string); }
    public static string TypeNameAlreadyDefinedDuplicate(object p0) { return default(string); }
    public static string TypeNameNotFound(object p0) { return default(string); }
    public static string TypeNotInAssociationSet(object p0, object p1, object p2) { return default(string); }
    public static string TypeNotInEntitySet(object p0, object p1, object p2) { return default(string); }
    public static string UnableToFindReflectedType(object p0, object p1) { return default(string); }
    public static string UnableToResolveAssembly(object p0) { return default(string); }
    public static string UnacceptableUri(object p0) { return default(string); }
    public static string UnexpectedRootElement(object p0, object p1, object p2) { return default(string); }
    public static string UnexpectedRootElementNoNamespace(object p0, object p1, object p2) { return default(string); }
    public static string UnexpectedTypeInCollection(object p0, object p1) { return default(string); }
    public static string UnexpectedXmlAttribute(object p0) { return default(string); }
    public static string UnexpectedXmlElement(object p0) { return default(string); }
    public static string UnexpectedXmlNodeType(object p0) { return default(string); }
    public static string UnknownExpressionResolutionClass(object p0) { return default(string); }
    public static string Update_AmbiguousForeignKey(object p0) { return default(string); }
    public static string Update_ConcurrencyError(object p0) { return default(string); }
    public static string Update_GeneratedDependent(object p0) { return default(string); }
    public static string Update_InsertingOrUpdatingReferenceToDeletedEntity(object p0) { return default(string); }
    public static string Update_MappingNotFound(object p0) { return default(string); }
    public static string Update_MissingEntity(object p0, object p1) { return default(string); }
    public static string Update_MissingFunctionMapping(object p0, object p1, object p2) { return default(string); }
    public static string Update_MissingRequiredEntity(object p0, object p1, object p2) { return default(string); }
    public static string Update_MissingRequiredRelationshipValue(object p0, object p1) { return default(string); }
    public static string Update_MissingResultColumn(object p0) { return default(string); }
    public static string Update_ModifyingIdentityColumn(object p0, object p1, object p2) { return default(string); }
    public static string Update_NotSupportedComputedKeyColumn(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string Update_NotSupportedIdentityType(object p0, object p1) { return default(string); }
    public static string Update_NotSupportedServerGenKey(object p0) { return default(string); }
    public static string Update_NullReturnValueForNonNullableMember(object p0, object p1) { return default(string); }
    public static string Update_NullValue(object p0) { return default(string); }
    public static string Update_RelationshipCardinalityConstraintViolation(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Update_RelationshipCardinalityConstraintViolationSingleValue(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string Update_RelationshipCardinalityViolation(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string Update_ReturnValueHasUnexpectedType(object p0, object p1, object p2, object p3) { return default(string); }
    public static string Update_SqlEntitySetWithoutDmlFunctions(object p0, object p1, object p2) { return default(string); }
    public static string Update_UnableToConvertRowsAffectedParameterToInt32(object p0, object p1) { return default(string); }
    public static string Update_UnsupportedCastArgument(object p0) { return default(string); }
    public static string Update_UnsupportedExpressionKind(object p0, object p1) { return default(string); }
    public static string Update_UnsupportedExtentType(object p0, object p1) { return default(string); }
    public static string Update_UnsupportedJoinType(object p0) { return default(string); }
    public static string Update_UnsupportedProjection(object p0) { return default(string); }
    public static string Validator_NoKeyMembers(object p0) { return default(string); }
    public static string Validator_NullableEntityKeyProperty(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_ComplexPropertyNotComplex(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_Convention_AmbiguousClrType(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_Convention_AttributeAssemblyReferenced(object p0) { return default(string); }
    public static string Validator_OSpace_Convention_BaseTypeIncompatible(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_Convention_BaseTypeNotLoaded(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_Convention_MissingOSpaceType(object p0) { return default(string); }
    public static string Validator_OSpace_Convention_MissingRequiredProperty(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_Convention_MultipleTypesWithSameName(object p0) { return default(string); }
    public static string Validator_OSpace_Convention_NonPrimitiveTypeProperty(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_Convention_RelationshipNotLoaded(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_Convention_ScalarPropertyMissginGetterOrSetter(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_Convention_SSpaceOSpaceTypeMismatch(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_Convention_Struct(object p0, object p1) { return default(string); }
    public static string Validator_OSpace_InvalidNavPropReturnType(object p0, object p1, object p2) { return default(string); }
    public static string Validator_OSpace_ScalarPropertyNotPrimitive(object p0, object p1, object p2) { return default(string); }
    public static string Validator_UnsupportedEnumUnderlyingType(object p0) { return default(string); }
    public static string ValueNotUnderstood(object p0, object p1) { return default(string); }
    public static string ViewGen_AssociationEndShouldBeMappedToKey(object p0, object p1) { return default(string); }
    public static string ViewGen_AssociationSet_AsUserString(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_AssociationSet_AsUserString_Negated(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_AssociationSetKey_Missing(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_Cannot_Disambiguate_MultiConstant(object p0, object p1) { return default(string); }
    public static string ViewGen_Cannot_Recover_Attributes(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_Cannot_Recover_Types(object p0, object p1) { return default(string); }
    public static string Viewgen_CannotGenerateQueryViewUnderNoValidation(object p0) { return default(string); }
    public static string ViewGen_Concurrency_Derived_Class(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_Concurrency_Invalid_Condition(object p0, object p1) { return default(string); }
    public static string Viewgen_ConfigurationErrorMsg(object p0) { return default(string); }
    public static string ViewGen_CQ_DomainConstraint(object p0) { return default(string); }
    public static string ViewGen_CQ_PartitionConstraint(object p0) { return default(string); }
    public static string ViewGen_Duplicate_CProperties(object p0) { return default(string); }
    public static string ViewGen_Duplicate_CProperties_IsMapped(object p0, object p1) { return default(string); }
    public static string ViewGen_EntitySet_AsUserString(object p0, object p1) { return default(string); }
    public static string ViewGen_EntitySet_AsUserString_Negated(object p0, object p1) { return default(string); }
    public static string ViewGen_EntitySetKey_Missing(object p0, object p1) { return default(string); }
    public static string ViewGen_ErrorLog(object p0) { return default(string); }
    public static string ViewGen_ErrorLog2(object p0) { return default(string); }
    public static string Viewgen_ErrorPattern_ConditionMemberIsMapped(object p0) { return default(string); }
    public static string Viewgen_ErrorPattern_DuplicateConditionValue(object p0) { return default(string); }
    public static string Viewgen_ErrorPattern_NotNullConditionMappedToNullableMember(object p0, object p1) { return default(string); }
    public static string Viewgen_ErrorPattern_Partition_MultipleTypesMappedToSameTable_WithoutCondition(object p0, object p1) { return default(string); }
    public static string Viewgen_ErrorPattern_TableMappedToMultipleES(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_Foreign_Key(object p0, object p1, object p2, object p3, object p4) { return default(string); }
    public static string ViewGen_Foreign_Key_LowerBound_MustBeOne(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_Foreign_Key_Missing_Relationship_Mapping(object p0) { return default(string); }
    public static string ViewGen_Foreign_Key_Missing_Table_Mapping(object p0, object p1) { return default(string); }
    public static string ViewGen_Foreign_Key_Not_Guaranteed_InCSpace(object p0) { return default(string); }
    public static string ViewGen_Foreign_Key_ParentTable_NotMappedToEnd(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string ViewGen_Foreign_Key_UpperBound_MustBeOne(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_HashOnMappingClosure_Not_Matching(object p0) { return default(string); }
    public static string ViewGen_InvalidCondition(object p0) { return default(string); }
    public static string ViewGen_KeyConstraint_Update_Violation_AssociationSet(object p0, object p1, object p2) { return default(string); }
    public static string ViewGen_KeyConstraint_Update_Violation_EntitySet(object p0, object p1, object p2, object p3) { return default(string); }
    public static string ViewGen_KeyConstraint_Violation(object p0, object p1, object p2, object p3, object p4, object p5) { return default(string); }
    public static string ViewGen_Missing_Set_Mapping(object p0) { return default(string); }
    public static string ViewGen_Missing_Sets_Mapping(object p0) { return default(string); }
    public static string ViewGen_Missing_Type_Mapping(object p0) { return default(string); }
    public static string Viewgen_MultipleFragmentsBetweenCandSExtentWithDistinct(object p0, object p1) { return default(string); }
    public static string ViewGen_NegatedCellConstant(object p0) { return default(string); }
    public static string ViewGen_No_Default_Value(object p0, object p1) { return default(string); }
    public static string ViewGen_No_Default_Value_For_Configuration(object p0) { return default(string); }
    public static string ViewGen_NonKeyProjectedWithOverlappingPartitions(object p0) { return default(string); }
    public static string ViewGen_NotNull_No_Projected_Slot(object p0) { return default(string); }
    public static string Viewgen_NullableMappingForNonNullableColumn(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_IsEqualTo(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_IsNonNullable(object p0) { return default(string); }
    public static string ViewGen_OneOfConst_IsNotEqualTo(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_IsNotOneOf(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_IsOneOf(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_IsOneOfTypes(object p0) { return default(string); }
    public static string ViewGen_OneOfConst_MustBeEqualTo(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_MustBeNonNullable(object p0) { return default(string); }
    public static string ViewGen_OneOfConst_MustBeNull(object p0) { return default(string); }
    public static string ViewGen_OneOfConst_MustBeOneOf(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_MustNotBeEqualTo(object p0, object p1) { return default(string); }
    public static string ViewGen_OneOfConst_MustNotBeOneOf(object p0, object p1) { return default(string); }
    public static string Viewgen_QV_RewritingNotFound(object p0) { return default(string); }
    public static string Viewgen_RightSideNotDisjoint(object p0) { return default(string); }
    public static string ViewGen_TableKey_Missing(object p0, object p1) { return default(string); }
  }
}
