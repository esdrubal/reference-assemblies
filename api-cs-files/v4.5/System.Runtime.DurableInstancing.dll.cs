namespace  {
  public static partial class SRCore {
    ...
    public static string CannotAcquireLockSpecific(object arg1) { return default(string); }
    public static string CannotAcquireLockSpecificWithOwner(object arg1, object arg2) { return default(string); }
    public static string GenericInstanceCommand(object arg1) { return default(string); }
    public static string InitialMetadataCannotBeDeleted(object arg1) { return default(string); }
    public static string InstanceCollisionSpecific(System.Guid arg1) { return default(string); }
    public static string InstanceCompleteSpecific(System.Guid arg1) { return default(string); }
    public static string InstanceHandleConflictSpecific(System.Guid arg1) { return default(string); }
    public static string InstanceLockLostSpecific(System.Guid arg1) { return default(string); }
    public static string InstanceNotReadySpecific(System.Guid arg1) { return default(string); }
    public static string InstanceOwnerSpecific(System.Guid arg1) { return default(string); }
    public static string KeyCollisionSpecific(object arg1) { return default(string); }
    public static string KeyCollisionSpecific(object arg1, object arg2, object arg3) { return default(string); }
    public static string KeyCollisionSpecificKeyOnly(object arg1) { return default(string); }
    public static string KeyCompleteSpecific(object arg1) { return default(string); }
    public static string KeyNotReadySpecific(object arg1) { return default(string); }
    public static string MetadataCannotContainNullValue(object arg1) { return default(string); }
    public static string NameCollisionOnCollect(System.Xml.Linq.XName arg1, object arg2) { return default(string); }
    public static string NameCollisionOnMap(System.Xml.Linq.XName arg1, object arg2) { return default(string); }
    public static string OutsideInstanceExecutionScope(object arg1) { return default(string); }
    public static string OutsideTransactionalCommand(object arg1) { return default(string); }
    public static string PersistencePipelineAbortThrew(object arg1) { return default(string); }
    public static string ProviderDoesNotSupportCommand(object arg1) { return default(string); }
    public static string WaitForEventsTimedOut(System.TimeSpan arg1) { return default(string); }
  }
}
